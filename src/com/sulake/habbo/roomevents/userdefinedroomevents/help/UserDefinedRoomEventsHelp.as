package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1706 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1121 = this.var_1706.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1121)
         {
            this.var_1121.procedure = this.onButtonClick;
         }
         this.var_1122 = this.var_1706.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1122)
         {
      ...
      {
         if(this.var_250 >= this.var_62.length - 1)
         {
         ...
         if(this.var_250 <= 0)
         {
            this.var_1121.disable();
         }
         else
         {
            this.var_1121.enable();
         }
      }
      ...
      {
         ++this.var_250;
         this.var_250 = Math.min(this.var_250,this.var_62.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_62[this.var_250][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_62[this.var_250][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_62[this.var_250][1]).value;
