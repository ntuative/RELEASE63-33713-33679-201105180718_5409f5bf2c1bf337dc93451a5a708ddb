package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1950:TriggerConfs;
      
      private var var_1949:ActionTypes;
      ...
      private var var_817:RoomObjectHightLighter;
      ...
      {
         this.var_1950 = new TriggerConfs();
         this.var_1949 = new ActionTypes();
         this.var_1948 = new ConditionTypes();
         this.var_267 = new Dictionary();
         super();
         this.var_84 = param1;
         this.var_817 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         {
            delete this.var_267[param1];
            this.var_817.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_267[param1] = param2;
            this.var_817.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1246 = new SliderWindowController(this.var_84,IWindowContainer(this.find(this.var_51,"delay_slider_container")),this.var_84.assets,0,20,1);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_817.hideAll(this.var_267);
         }
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1950);
         this.refreshConfigureElement(this.var_1949);
