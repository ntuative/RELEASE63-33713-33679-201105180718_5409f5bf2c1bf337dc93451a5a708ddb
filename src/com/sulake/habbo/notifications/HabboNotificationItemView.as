package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_487:int = 70;
      
      public static const const_1901:int = 4;
      
      private static const name_3:int = 0;
      
      private static const const_506:int = 1;
      ...
      private var var_233:HabboNotificationItem;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_2022 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_2022 = 15;
         }
         this.var_2020 = this._window.height;
         this.var_1575 = 4;
         this._blend = 0;
         this._state = name_3;
      ...
      {
         if(param1.badgeId != this.var_233.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_506:
               ...
               _loc2_ = Number(this.var_1303) / Number(this.var_1044["time_fade_in"]);
               if(this.var_1303 > int(this.var_1044["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1077:
               ...
               if(this.var_1574 > int(this.var_1044["time_display"]) && !this.var_2021)
               {
                  this.startFadeOut();
               }
               break;
            case const_1076:
               ...
               _loc3_ = 1 - Number(this.var_1302) / Number(this.var_1044["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1302 > int(this.var_1044["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_2022;
         if(this._window.height < this.var_2020)
         {
            this._window.height = this.var_2020;
         }
      }
