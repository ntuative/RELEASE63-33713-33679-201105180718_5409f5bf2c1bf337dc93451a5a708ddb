package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1958:String = "badge_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1550 = param7;
         this.var_2585 = param5;
         this.var_1994 = param6;
         this.var_62 = param10;
         this._assets = param8;
         this.var_358 = param13;
         this._communication = param12;
         param13.events.addEventListener(BadgeImageReadyEvent.const_107,this.onBadgeImageReady);
         ...
         this._window.center();
         this.var_2752 = this.var_62.getBadgeName(this.var_319);
         this.var_2756 = this.var_62.getBadgeDesc(this.var_319);
         this.var_2755 = this.var_62.getAchievementNameForFacebook(this.var_319,this.var_358.userName,this.var_358.realName,this.var_1173);
         this.var_2753 = this.var_62.getAchievementDescForFacebook(this.var_319,this.var_358.userName,this.var_358.realName,this.var_1173);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2751 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_62.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1718.toString());
         this.var_62.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1550.toString());
         this.var_62.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1550.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1994;
         var _loc17_:String = this.var_1994 == 0 ? "pixels" : "activitypoints";
         this.var_62.registerParameter(_loc16_,_loc17_,"" + this.var_2585);
         _loc15_.caption = this.var_62.getKey(_loc16_);
         this._window.findChildByName("achievement_info").caption = this._desc;
         this.setBadge(param13.getBadgeImage(param1),this.const_1958);
      ...
      {
         this.var_62.registerParameter(param1,"badge_name",this.var_2752);
         this.var_62.registerParameter(param1,"badge_desc",this.var_2756);
         this.var_62.registerParameter(param1,"badge_name_fb",this.var_2755);
         this.var_62.registerParameter(param1,"badge_desc_fb",this.var_2753);
         this.var_62.registerParameter(param1,"level",this.var_1173.toString());
         this.var_62.registerParameter(param1,"name",this.var_358.userName);
         return this.var_62.registerParameter(param1,"realname",this.var_358.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_358.events.removeEventListener(BadgeImageReadyEvent.const_107,this.onBadgeImageReady);
            this.var_358 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.setBadge(param1.badgeImage,this.const_1958);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_319,this._feedTitleFb,this.var_2751,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2754));
