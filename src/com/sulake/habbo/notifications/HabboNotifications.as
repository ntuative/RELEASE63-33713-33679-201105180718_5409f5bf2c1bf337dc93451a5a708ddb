package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1568:String = "pixelbalance";
      
      private static const const_1573:String = "badges";
      
      private static const const_1572:String = "selectbadge";
      
      private static const const_1567:String = "inventory";
      
      private static const const_1570:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1574:String = "friendlist";
      
      private static const const_1571:String = "pet_inventory";
      
      private static const const_1569:String = "go_to_room";
      ...
      private var var_396:HabboNotificationViewManager;
      
      private var var_236:HabboAlertDialogManager;
      
      private var var_844:ParkBusDialogManager;
      ...
      private var var_1048:ClubPromoNotification;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         this.var_1309.push(_loc8_);
         return this.var_1309.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1309.splice(0,1);
      ...
      public function setQuestTrackerVisible(param1:Boolean) : void
      {
         if(this.var_396)
         {
            this.var_396.topMarginIncrease = !!param1 ? 135 : 0;
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1581[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_358);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1581[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1581[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      {
         this.var_396 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_1045["styles"],this.var_1045["view"]);
         ...
         registerUpdateReceiver(this.var_396,1);
         registerUpdateReceiver(this,2);
         this.var_358.events.addEventListener(BadgeImageReadyEvent.const_107,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_358.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1281,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1281,null);
            }
         }
      }
      ...
      {
         this.addItem(param1,NotificationType.const_938,null);
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_549.createAvatarImage(param2,AvatarScaleType.const_58);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_358.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_66)
               {
                  _loc7_ = this.var_358.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_358.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1897,_loc5_);
               }
            }
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_66:
               ...
               break;
            case CatalogPageMessageProductData.const_217:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1233)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1903,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1737)
         {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1048 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_396.isSpaceAvailable() && this.var_1309.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_396.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1573:
               if(this.var_13 != null)
               {
                  this.var_13.toggleInventoryPage(InventoryCategory.const_339);
               }
               break;
            case const_1572:
               break;
            ...
            case const_1571:
               if(this.var_13 != null && this.var_13.hasRoomSession)
               {
                  this.var_13.toggleInventoryPage(InventoryCategory.const_122);
               }
               break;
            case const_1570:
               break;
      ...
      {
         if(param1 != null && this.var_396 != null)
         {
            this.var_396.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_844 == null)
         {
            this.var_844 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_844 != null)
         {
            this.var_844.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1325,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1325,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_549.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_58);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2839)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_938,null);
            this.var_2839 = true;
      ...
      {
         if(param2.type == WindowEvent.const_182 || param2.type == WindowEvent.const_609)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_938,_loc6_);
      }
   }
}
