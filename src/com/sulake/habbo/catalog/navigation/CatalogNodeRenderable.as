package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1342:Number = 4285716709;
      ...
      private var var_1652:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_2936:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1652 == 4294967295)
            {
               this.var_1652 = _loc1_.color;
            }
            _loc1_.color = const_1342;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1703;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1618;
            }
         }
      }
      ...
      {
         this.var_60 = navigator.catalog.windowManager.buildFromXML(var_1373) as IItemListWindow;
         if(this.var_60 == null)
         {
