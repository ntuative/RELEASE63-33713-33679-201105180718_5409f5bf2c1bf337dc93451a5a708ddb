package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyItem
   {
      ...
      public function ClubBuyItem(param1:ClubBuyOfferData, param2:ICatalogPage)
      {
         ...
         this._window = this.include.viewer.catalog.windowManager.buildFromXML(_loc3_) as IWindowContainer;
      ...
      {
         var _loc2_:ClubBuyController = (this.include.viewer.catalog as HabboCatalog).getClubBuyController();
         (this.include.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_94,this.include.pageId);
      }
      
      private function getAssetXML(param1:String) : XML
      {
         if(!this.include || !this.include.viewer || !this.include.viewer.catalog || !this.include.viewer.catalog.assets)
         {
            return null;
         }
         var _loc2_:XmlAsset = this.include.viewer.catalog.assets.getAssetByName(param1) as XmlAsset;
         if(_loc2_ == null)
         {
            return null;
         }
