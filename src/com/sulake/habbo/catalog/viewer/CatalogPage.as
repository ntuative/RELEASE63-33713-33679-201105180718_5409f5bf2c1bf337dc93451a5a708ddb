package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1912:String = "ctlg_";
       
      
      protected var var_2152:XML;
      ...
      private var var_1203:ItemGridCatalogWidget;
      ...
      {
         return this._localization.getLinks(this.var_1202);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1202);
      }
      ...
      {
         var _loc2_:String = const_1912 + param1;
         ...
         this.var_2152 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2152) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1781:
               if(this.var_1203 == null)
               {
                  this.var_1203 = new ItemGridCatalogWidget(param1);
                  this.var_36.push(this.var_1203);
               }
               break;
