package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1031:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_200:IItemGrid;
      
      protected var _icon:IBitmapWrapperWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_488:Object;
      ...
      {
         this._view.getChildByName(const_1031).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1031).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_87,MouseCursorType.const_908);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_908);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_43)
         {
            ...
            this.var_200.select(this);
            this.var_488 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_488 != null && this.var_488 == param2)
         {
            _loc3_ = this.var_200.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_488 = null;
            }
