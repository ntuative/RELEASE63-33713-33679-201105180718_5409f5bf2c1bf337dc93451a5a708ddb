package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_411:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer)
      {
         ...
         super(param1);
         this.var_411 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_411)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_411.numSelectables)
            {
               _loc3_ = this.var_411.getSelectableAt(_loc2_);
               if(_loc3_ is ISelectableWindow)
               {
                  _loc3_.addEventListener(WindowEvent.const_48,this.onSelectGroup);
               }
               _loc2_++;
            }
         }
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_106[this.var_536]);
      ...
      {
         var _loc2_:int = this.var_688[this.var_536];
         var _loc3_:Offer = this.var_208[this.var_536][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_475.numGridItems)
         {
            _loc2_ = this.var_208[this.var_536][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_688[this.var_536] = (this.var_208[this.var_536] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_407 || _loc1_.pricingModel == Offer.const_427))
            {
               continue;
            }
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_411.method_2(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_411.setSelected(this.var_411.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            if(var_475)
            {
               var_475.destroyGridItems();
            }
            page.replaceOffers(this.var_208[this.var_536],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_688[this.var_536];
