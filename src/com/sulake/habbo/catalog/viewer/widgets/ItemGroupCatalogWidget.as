package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      {
         var _loc2_:Offer = this.var_208[this.var_536][this.var_688];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_536 = var_475.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_536];
         var _loc3_:Array = this.var_208[this.var_536] as Array;
      ...
      {
         var _loc2_:Array = this.var_208[this.var_536] as Array;
      ...
      private function updateGridWithSelectedColour() : void
      {
         ...
         var _loc1_:Array = this.var_208[this.var_536] as Array;
