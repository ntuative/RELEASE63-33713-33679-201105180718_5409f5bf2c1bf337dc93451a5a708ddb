package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_452:IButtonWindow;
      
      private var var_1236:ITextWindow;
      ...
      {
         super(param1);
         this.var_452 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1236 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_452 != null)
         {
            this.var_452.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_452.disable();
         }
         this.var_1235 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
      ...
      override public function dispose() : void
      {
         if(this.var_452 != null)
         {
            this.var_452.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1236.text = _loc8_;
            }
         }
         else if(this.var_1236 != null)
         {
            this.var_1236.text = "";
         }
         if(this.var_452 != null)
