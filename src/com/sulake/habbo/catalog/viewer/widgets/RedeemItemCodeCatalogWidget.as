package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_883.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_883 = null;
         }
         if(this.var_882 != null)
         {
            this.var_882.removeEventListener(WindowKeyboardEvent.const_190,this.windowKeyEventProcessor);
            this.var_882 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_883 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_883 != null)
         {
            this.var_883.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_882 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_882 != null)
         {
            this.var_882.addEventListener(WindowKeyboardEvent.const_190,this.windowKeyEventProcessor);
         }
         return true;
      }
