   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_916,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_264,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_911,this.deActivateScrollbar);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_207.stop();
            this.var_207.removeEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_207 = null;
         }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_475 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_711 >= 0 && this.var_711 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_711];
                  this.loadGraphics(_loc4_);
                  _loc4_.productContainer.grid = this;
               }
               ++this.var_711;
               if(this.var_711 >= _loc2_)
               {
                  this.resetTimer();
                  break;
               }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_535)
         {
            ++this.var_1635;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1635);
         }
      }
