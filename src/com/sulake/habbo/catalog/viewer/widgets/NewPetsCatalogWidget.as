package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1539:int = 18;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_545 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_545 < 8)
         {
            return false;
         }
         this.var_2286 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_202 != null && this.var_202.length > 0)
         {
            this.var_390 = this.var_202[0];
         }
         else
         {
            this.var_390 = -1;
         }
         this._offers.add(this.var_545,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_202 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1539 && _loc2_ < this.var_202.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_545,this.var_202[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_202 != null && this.var_202.length > 0)
         {
            ...
            this.var_390 = this.var_202[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_545,this.var_390),this.getRaceLocalizationKey(this.var_545,this.var_390));
            }
         }
         return this.getRaceLocalizationKey(this.var_545,this.var_390);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_390 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_545;
         var _loc3_:int = this.var_390;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_390 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
