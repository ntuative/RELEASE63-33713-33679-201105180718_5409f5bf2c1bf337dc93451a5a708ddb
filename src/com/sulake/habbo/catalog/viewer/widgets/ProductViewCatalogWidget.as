package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1603:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1075 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1332 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_91 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_2091 = new Point(this.var_91.x,this.var_91.y);
         this.var_564 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1603 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_2090 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_564 != null)
         {
            this.var_564.visible = false;
            this.var_564.destroyGridItems();
         }
         if(this.var_1603 != null)
         {
            this.var_1603.visible = false;
         }
         ...
         this.var_1075.text = _loc4_;
         this.var_1332.text = _loc5_;
         this.var_1075.height = this.var_1075.textHeight + 5;
         this.var_1332.y = this.var_1075.y + this.var_1075.height;
         this.var_1332.height = Math.max(130,this.var_1332.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_535:
                  _loc6_ = this.var_2090.clone();
                  if(this.var_564 != null)
                  {
                     this.var_564.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_564,this.var_1603,this.var_1801);
                     ...
                     case ProductTypeEnum.const_217:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_317,AvatarAction.const_489);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2902)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2902 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_91 != null && true)
         {
            ...
            this.var_91.x = this.var_2091.x;
            this.var_91.y = this.var_2091.y;
            if(param3 != null)
            {
