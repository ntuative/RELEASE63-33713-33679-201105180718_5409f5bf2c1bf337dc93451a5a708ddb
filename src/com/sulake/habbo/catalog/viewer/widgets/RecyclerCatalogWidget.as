package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IRecyclerVisualization
   {
      ...
      private var var_298:CatalogObjectMover;
      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_25:
               if(this.var_298 != null)
               {
                  this.var_298.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(this.var_298 == null)
               {
                  this.var_298 = new CatalogObjectMover();
                  this.var_298.mainContainer = window;
                  this.var_298.roomEngine = _loc3_;
               }
               this.var_298.onMainContainerEvent(param1,param2,_loc4_);
         }
      }
