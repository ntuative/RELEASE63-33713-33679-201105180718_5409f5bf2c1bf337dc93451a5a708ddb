package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      private var var_763:Offer;
      
      protected var var_475:IItemGridWindow;
      
      protected var var_1801:XML;
      ...
      {
         super(param1);
         this.var_475 = _window.findChildByName("botGrid") as IItemGridWindow;
      ...
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_763,page.pageId);
      }
      
      private function onBotDefinitions(param1:RentableBotDefinitionWidgetEvent) : void
      {
         this.var_1452 = param1.botFigureData;
      ...
      private function populateGridItems() : void
      {
         ...
         this.var_1801 = _loc1_.content as XML;
         var _loc2_:int = 0;
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1801) as IWindowContainer;
         this.var_475.addGridItem(_loc2_);
         param1.productContainer.view = _loc2_;
         var _loc3_:String = this.var_1452.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         if(_loc5_)
         {
            ...
            _loc4_.invalidate();
            this.var_1790.add(_loc3_,param1.offerId);
            _loc5_.dispose();
         }
      }
      ...
      {
         var _loc1_:String = this.var_1452.getValue(this.var_763.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc1_.registerParameter(_loc5_,"credits",String(this.var_763.priceInCredits));
            _loc1_.registerParameter(_loc5_,"pixels",String(this.var_763.priceInActivityPoints));
            _loc2_.text = _loc1_.getKey(_loc5_);
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(this.var_763.localizationId);
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc2_:int = this.var_1790.getValue(param1);
         if(true)
         {
            return;
         }
         for each(_loc3_ in page.offers)
         {
            ...
            {
               _loc4_ = this.var_1452.getValue(_loc3_.productContainer.firstProduct.extraParam.toLowerCase());
               ...
               if(_loc7_)
               {
                  ...
                  _loc6_.invalidate();
                  _loc7_.dispose();
                  if(this.var_763.offerId == _loc2_)
                  {
                     this.updatePreviewImage();
                  }
               }
