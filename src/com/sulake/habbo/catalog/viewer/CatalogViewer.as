package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_2079:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array, param5:int) : void
      {
         ...
         {
            if(this.include.pageId == param1)
            {
               if(param5 > -1)
               {
                  this.include.selectOffer(param5);
               }
               return;
            }
            this._container.removeChild(this.include.window);
            this.include.dispose();
         }
         var _loc6_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,this.var_2079);
         this.include = _loc6_;
      ...
      {
         return this.include.dispatchWidgetEvent(param1);
      }
      ...
      public function getCurrentLayoutCode() : String
      {
         ...
         return this.include.layoutCode;
      }
   }
}
