package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_584 != const_997;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1690 != RecyclerStatusMessageEvent.const_1250;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_584 == const_445;
      }
      ...
      {
         this.var_584 = const_998;
         this.var_113 = new Array(const_223);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1711:
               this.var_584 = const_445;
            ...
            case RecyclerStatusMessageEvent.const_1250:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1851:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1233:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1635:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_113.length < const_223)
         {
            return false;
         }
         var _loc1_:int = 0;
