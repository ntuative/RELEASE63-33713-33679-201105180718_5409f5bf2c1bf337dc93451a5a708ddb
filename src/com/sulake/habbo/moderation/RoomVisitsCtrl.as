package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_888:Array = [];
      
      private static var var_1676:int = 200;
      ...
      {
         this.var_718 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1617;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_888.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_718.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_888.length < var_1676)
         {
            ...
            param1.width = this.var_718.width;
            param1.height = this.var_718.height;
            var_888.push(param1);
         }
         else
         {
