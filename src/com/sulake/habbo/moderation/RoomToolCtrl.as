package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_552:ITextFieldWindow;
      
      private var var_625:Boolean = true;
      
      private var var_944:ICheckBoxWindow;
      
      private var var_1462:ICheckBoxWindow;
      
      private var var_1463:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_34.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_356));
         Logger.log("BEGINNING TO SHOW: " + this.var_356);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1699;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_356);
         if(param1.flatId != this.var_356)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_356);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_552 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_552.procedure = this.onInputClick;
         ...
         this.var_944 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1462 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1463 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_776,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_625 || this.var_552.text == "")
         {
            this.var_34.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_944.isSelected);
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1648,_loc2_,this.var_552.text,"",""));
         if(this.var_1462.isSelected || this.var_1463.isSelected || this.var_944.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1462.isSelected,this.var_1463.isSelected,this.var_944.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1767);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1870);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.roomMessageTemplates[this.var_1178.selection];
         if(_loc3_ != null)
         {
            this.var_625 = false;
            this.var_552.text = _loc3_;
         }
      }
   }
}
