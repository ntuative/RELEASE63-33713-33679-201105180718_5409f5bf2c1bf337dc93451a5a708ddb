package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_784:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2344 = param2.pickerUserId;
         this.var_2570 = param2.pickerUserName;
         this.var_1450 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         if(this.var_784 == null || param1.priority > this.var_784.timeStamp)
         {
            this.var_784 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_784;
         if(_loc1_ == null)
         {
