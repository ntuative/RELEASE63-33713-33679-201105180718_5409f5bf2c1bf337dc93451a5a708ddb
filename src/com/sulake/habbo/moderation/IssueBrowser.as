package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2228:String = "my_issues";
      
      private const const_2230:String = "open_issues";
      
      private const const_2229:String = "picked_issues";
      
      private const const_2239:String = "closed_issues";
      ...
      private var var_1988:IIssueBrowserView;
      
      private var var_1990:IIssueBrowserView;
      
      private var var_1989:PickedIssuesView;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2228:
               if(this.var_1988 == null)
               {
                  this.var_1988 = new MyIssuesView(this.issueManager,this,this.var_275.container);
               }
               return this.var_1988;
            case this.const_2230:
               if(this.var_1990 == null)
               {
                  this.var_1990 = new OpenIssuesView(this.issueManager,this,this.var_275.container);
               }
               return this.var_1990;
            case this.const_2229:
               if(this.var_1989 == null)
               {
                  this.var_1989 = new PickedIssuesView(this.issueManager,this,this.var_275.container);
               }
