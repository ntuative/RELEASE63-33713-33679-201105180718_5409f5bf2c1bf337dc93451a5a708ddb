package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1222:String = "issue_bundle_open";
      
      public static const const_820:String = "issue_bundle_my";
      
      public static const const_1217:String = "issue_bundle_picked";
      
      public static const const_1668:int = 15000;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_664 = new IssueBrowser(this,this.var_66.windowManager,this.var_66.assets);
         this.var_1245 = [];
         this.var_1244 = [];
         this.var_997 = new Map();
         this.var_2680 = parseInt(this.var_66.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1946 = new Timer(const_1668,0);
         this.var_1946.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1946.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1245 = this.var_1245.concat(_loc4_.getIssueIds());
      }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1244 = this.var_1244.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_66.soundManager.playSound(HabboSoundTypesEnum.const_1214);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1672)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         if(this.var_1245.indexOf(param1.issueId) != -1)
         {
         ...
         {
            _loc6_ = this.getBundles(const_820);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1244.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2680);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_997.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_997.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_997.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_997.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_376 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_997.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
