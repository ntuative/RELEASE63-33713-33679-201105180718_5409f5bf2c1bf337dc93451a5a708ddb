package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function createView() : void
      {
         ...
         this.var_521 = new UserInfoCtrl(this._window,this.var_66,_loc3_.message);
         this.var_1201 = new UserInfoCtrl(this._window,this.var_66,_loc3_.message);
         ...
         {
            this.var_1201.load(_loc4_,this.var_162.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_66 != null && this.var_66.issueManager != null && this.var_162 != null)
         {
            this.var_66.issueManager.removeHandler(this.var_162.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.issueManager.closeBundle(this.var_162.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.issueManager.closeBundle(this.var_162.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.issueManager.closeBundle(this.var_162.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.issueManager.releaseBundle(this.var_162.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_66,WindowTracker.const_1147,_loc2_),this._window,false,false,true);
      }
