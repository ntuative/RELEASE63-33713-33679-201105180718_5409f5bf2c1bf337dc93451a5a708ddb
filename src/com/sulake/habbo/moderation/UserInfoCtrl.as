package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1073:int = 3600;
      
      private static const const_1070:int = 86400;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         if(param1 < 2 * const_1073)
         {
            return Math.round(param1 / const_1071) + " mins ago";
         }
         if(param1 < 2 * const_1070)
         {
            return Math.round(param1 / const_1073) + " hours ago";
         }
         if(param1 < 2 * const_1072)
         {
            return Math.round(param1 / const_1070) + " days ago";
         }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1289.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_34.getXmlWindow("user_info"));
            this.var_1289.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_34,WindowTracker.const_1228,this._data.userId),this._callerFrame,this.var_1288,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new RoomVisitsCtrl(this.var_34,this._data.userId),this._callerFrame,this.var_1288,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new SendMsgsCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1564),this._callerFrame,this.var_1288,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ModActionCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1564),this._callerFrame,this.var_1288,false,true);
      }
