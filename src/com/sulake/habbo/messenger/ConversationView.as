package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1547:int = 10;
      ...
      private var var_2778:IScrollbarWindow;
      
      private var var_2004:IContainerButtonWindow;
      
      private var var_60:IItemListWindow;
      
      private var var_547:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_134 = param1;
         this.var_2004 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_60 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2778 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1068 + const_1548)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1547;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_547 == null || _loc1_.id != this.var_547.id)
         {
            this.var_547 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_547.followingAllowed)
         {
            this.var_2004.enable();
         }
         else
         {
            this.var_2004.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_60.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_547.messages.length - const_1068);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_547.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_547.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_691 || param3.type == Message.const_689 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_547.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_134.send(new FollowFriendMessageComposer(this.var_547.id));
