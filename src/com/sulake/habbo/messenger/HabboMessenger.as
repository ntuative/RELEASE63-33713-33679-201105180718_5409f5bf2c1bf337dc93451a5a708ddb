package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      {
         if(this._windowManager && this._communication && this.var_178 && this._localization && this._friendList && this.var_965 && this._soundManager)
         {
            unlock();
      ...
      public function playSendSound() : void
      {
         ...
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1176);
         }
      }
      
      public function isOpen() : Boolean
      {
         return this.var_230.isMessengerOpen();
      }
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_689,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function addMsg(param1:Message) : void
      {
         ...
         if(!this.var_230.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
               this._soundManager.playSound(HabboSoundTypesEnum.const_1289);
            }
         }
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1321,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
