package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1036:ConversationsTabView;
      
      private var var_1035:ITextFieldWindow;
      
      private var var_17:IFrameWindow;
      
      private var var_1568:ConversationView;
      ...
      public function refresh() : void
      {
         ...
         this.var_1036.refresh();
         this.var_1568.refresh();
         if(this.var_134.conversations.openConversations.length < 1)
         {
            this.var_17.visible = false;
         }
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1568.addMessage(param2);
      }
      
      private function prepareContent() : void
      {
         this.var_17 = IFrameWindow(this.var_134.getXmlWindow("main_window"));
         ...
         this.var_1036 = new ConversationsTabView(this.var_134,this.var_17);
         this.var_1036.refresh();
         this.var_1035 = ITextFieldWindow(this.var_17.findChildByName("message_input"));
         this.var_1035.addEventListener(WindowKeyboardEvent.const_190,this.onMessageInput);
         this.var_1568 = new ConversationView(this.var_134,this.var_17);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_764,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1309,true);
         this.var_17.center();
      }
      ...
      private function onMessageInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc2_ = 120;
            _loc3_ = this.var_1035.text;
            if(_loc3_.length > _loc2_)
            {
               this.var_1035.text = _loc3_.substring(0,_loc2_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_1035.text;
         ...
         this.var_1035.text = "";
         this.var_134.conversations.addMessageAndUpdateView(new Message(Message.const_691,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      
      public function getTabCount() : int
      {
         return this.var_1036 == null ? 7 : int(this.var_1036.getTabCount());
      }
   }
}
