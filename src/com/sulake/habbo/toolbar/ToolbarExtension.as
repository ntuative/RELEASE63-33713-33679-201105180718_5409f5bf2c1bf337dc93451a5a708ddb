package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarExtension
   {
      ...
      private static const const_1450:uint = 12247545;
      
      private static const const_1451:String = "HELP";
      
      private static const const_1452:String = "ROOMINFO";
      ...
      private var var_379:IWindow;
      
      private var var_645:IWindowContainer;
      
      private const const_924:int = 41;
      ...
      public function ToolbarExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_379 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_60.removeListItem(this.var_379);
      }
      
      public function showRoomInfo() : void
      {
         this.var_60.addListItemAt(this.var_379,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_980;
         _loc3_.y = this.const_924;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_645)
         {
            this.var_645 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1451);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1452);
               break;
            case "confirm":
               if(false)
               {
