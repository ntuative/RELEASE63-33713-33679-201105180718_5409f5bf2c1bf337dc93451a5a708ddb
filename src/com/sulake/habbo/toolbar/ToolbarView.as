package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1430:Point = new Point(3,3);
      
      private static const const_1513:uint = 7433577;
      
      private static const const_1514:uint = 5723213;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1430;
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_452 ? this.var_1542 : this.var_1541;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_452)
         {
            param1.color = const_1513;
         }
         else
         {
            param1.color = const_1514;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1541 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1542)
         {
            this.var_1542.dispose();
         }
         this.var_1542 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1008.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_1022;
            _loc2_.y = const_1022;
            this.var_1008.add(param1,_loc2_);
         }
         return _loc2_;
      }
