package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1075:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1564:String = "sendAccessTokenToServer";
      
      private static const const_1565:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1564,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1565,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1075);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1075);
         }
      }
