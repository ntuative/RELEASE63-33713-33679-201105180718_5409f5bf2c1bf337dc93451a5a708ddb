package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private const const_1955:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_658 = param1;
            this.var_56.initConnection(HabboConnectionType.const_241);
         }
      }
      ...
      {
         if(this.var_56 && this.var_143 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_658 = this.var_143.getKey("sso.ticket",null);
         this.var_1928 = this.var_143.getKey("flash.client.url","");
         this.var_2654 = this.var_143.getKey("external.variables.txt","");
         if(this.var_232 == null)
         {
            this.var_232 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_56.mode = HabboConnectionType.const_94;
            if(this.var_658)
            {
               this.var_56.initConnection(HabboConnectionType.const_241);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_631,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1722);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_56.mode = HabboConnectionType.const_1271;
            }
         }
         this.var_56.initConnection(HabboConnectionType.const_241);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_922);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2656 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_56.mode)
         {
            case HabboConnectionType.const_94:
               ...
               this.var_1510 = _loc4_;
               this.var_232.loadBannerImage(_loc7_ + "?token=" + this.var_1510,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1271:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1828:
               this.var_982 = this.generateRandomHexString(30);
               ...
               this.var_539.init(this.var_982);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2656);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1928,this.var_2654));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1955,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2655)
         {
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         if(_loc2_.length > 0)
         {
            _loc2_ = this.method_10(_loc2_,param1.reasonString);
            _loc2_ = this.setOriginProperty(_loc2_);
      ...
      private function method_10(param1:String, param2:String) : String
      {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1510);
