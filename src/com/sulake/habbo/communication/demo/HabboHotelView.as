package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_924:IDesktopWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_1113:Function;
      
      private var var_1112:Function;
      
      private var var_722:IAssetLibrary;
      
      private var var_1114:uint = 0;
      ...
      public function HabboHotelView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher, param4:Boolean = true)
      {
         ...
         this.var_722 = param2;
         this._events = param3;
         this.var_924 = param1.getDesktop(0);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_722.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_722.getAssetByName(_loc2_.assetName);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_722.loadAssetFromFile("hotel_view_banner_" + this.var_1114,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      public function show() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_924.addChildAt(this._window,0);
         }
      }
      ...
      public function hide() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_924.removeChild(this._window);
         }
      }
   }
}
