package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_631:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_169.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_157,HabboWindowStyle.const_46,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1955,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_169.habboConfiguration.getKey("use.sso","false") == "true")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1955,"/");
         ...
         {
            dispatchEvent(new Event(const_631));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_144.removeEventListener(SSOTicket.const_381,this.onParsedTicketSuccess);
            this.var_144.removeEventListener(SSOTicket.const_336,this.onParsedTicketFailure);
            this.var_144 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_144 = new SSOTicket(this.var_169.assets,_loc3_,_loc2_,param1);
         this.var_144.addEventListener(SSOTicket.const_381,this.onParsedTicketSuccess);
         this.var_144.addEventListener(SSOTicket.const_336,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_169.flashClientUrl = this.var_144.flashClientUrl;
         this.var_169.ssoTicket = this.var_144.ticket;
         this.var_144.removeEventListener(SSOTicket.const_381,this.onParsedTicketSuccess);
         this.var_144.removeEventListener(SSOTicket.const_336,this.onParsedTicketFailure);
         this.var_144 = null;
         dispatchEvent(new Event(const_631));
