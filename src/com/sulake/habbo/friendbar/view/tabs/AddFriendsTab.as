package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class AddFriendsTab extends Tab
   {
      ...
      private static const const_1959:String = "title";
      
      private static const BUTTON:String = "button";
      
      private static const const_1543:String = "addFriendsTabXML";
      
      private static const const_1542:String = "add_friends_icon_png";
      
      private static var var_1023:int = -1;
      
      private static const const_71:uint = 6907230;
      
      private static const const_1067:uint = 9209986;
      ...
      {
         var _loc1_:IWindowContainer = false ? const_455.pop() : var_1337.buildFromXML(var_863.getAssetByName(const_1543).content as XML) as IWindowContainer;
         ...
         if(var_1023 < 0)
         {
            var_1023 = _loc1_.height;
         }
         _loc1_.height = name_1;
         var _loc3_:IBitmapWrapperWindow = _loc1_.findChildByName(const_1086) as IBitmapWrapperWindow;
         _loc3_.disposesBitmap = false;
         _loc3_.bitmap = var_863.getAssetByName(const_1542).content as BitmapData;
