package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1585:String = "facebook_piece_xml";
      
      private static const const_1583:String = "controls_piece_xml";
      
      private static const const_459:String = "list";
      
      private static const const_672:String = "header";
      
      private static const const_1084:String = "facebook";
      
      private static const const_1085:String = "controls";
      ...
      private static const const_1083:String = "btn_visit";
      
      private static const const_1086:String = "icon";
      
      private static const const_71:uint = 10338138;
      
      private static const const_1067:uint = 13891476;
      
      private static const POOL:Array = [];
      
      private static const const_455:Array = [];
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IItemListWindow = IItemListWindow(param1.getChildByName(const_459));
         _loc3_ = _loc2_.getListItemByName(const_1084) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         _loc3_ = _loc2_.getListItemByName(const_1085) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
      ...
      override public function select() : void
      {
         ...
         if(!selected)
         {
            _loc1_ = IItemListWindow(window.getChildByName(const_459));
            if(this.friend.realName != null && this.friend.realName != "")
            {
               _loc2_ = var_1337.buildFromXML(var_863.getAssetByName(const_1585).content as XML) as IWindowContainer;
               _loc2_.name = const_1084;
               _loc2_.getChildByName(const_457).caption = this.friend.realName;
               var_2112.crop(_loc2_.getChildByName(const_457) as ITextWindow);
               _loc3_ = IBitmapWrapperWindow(_loc2_.getChildByName(const_1086));
            ...
            {
               _loc2_ = var_1337.buildFromXML(var_863.getAssetByName(const_1583).content as XML) as IWindowContainer;
               _loc2_.name = const_1085;
               ...
               _loc4_ = _loc2_.getChildByName(const_1083);
               if(_loc4_)
               {
      ...
      {
         super.expose();
         _window.color = !!exposed ? uint(const_1067) : uint(const_71);
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_326)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_459)).getListItemByName(const_672) as IWindowContainer;
            _loc1_.findChildByName(const_457).caption = this.var_326.name;
            var_2112.crop(_loc1_.getChildByName(const_457) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_671));
            _loc2_.bitmap = var_1615.getAvatarFaceBitmap(this.var_326.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_455.pop() : var_1337.buildFromXML(var_863.getAssetByName(const_1584).content as XML) as IWindowContainer;
         var _loc2_:IBitmapWrapperWindow = IBitmapWrapperWindow(_loc1_.findChildByName(const_671));
      ...
      private function releaseEntityWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            param1.width = name_5;
            param1.height = name_1;
            _loc3_ = IBitmapWrapperWindow(param1.findChildByName(const_671));
            _loc3_.bitmap = null;
            purgeEntityPieces(param1);
            if(const_455.indexOf(param1) == -1)
            {
               const_455.push(param1);
            }
         }
      }
      ...
      private function onButtonClick(param1:WindowMouseEvent) : void
      {
         if(!disposed && !recycled)
         {
            ...
            {
               case const_986:
                  if(var_1079 && this.var_326)
                  {
                     var_1079.startConversation(this.var_326.id);
                     this.deselect();
                  }
                  break;
               case const_1083:
                  if(var_1079 && this.var_326)
                  {
                     var_1079.followToRoom(this.var_326.id);
                     this.deselect();
                  }
            }
         }
