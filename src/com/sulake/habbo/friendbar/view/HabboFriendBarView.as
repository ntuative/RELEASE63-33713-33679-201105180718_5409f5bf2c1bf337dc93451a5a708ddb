package com.sulake.habbo.friendbar.view
{
   ...
   public class HabboFriendBarView extends Component implements IHabboFriendBarView, IAvatarImageListener
   {
      ...
      private static const const_1603:int = 127;
      
      private static const const_458:int = 1;
      
      private static const const_1588:int = 2;
      
      private static const const_674:int = 3;
      
      private static const const_1088:int = 3;
      
      private static const const_1586:Boolean = false;
      
      private static const const_673:int = 3;
      
      private static const const_1595:String = "arrow";
      
      private static const const_1599:String = "left";
      
      private static const const_1589:String = "right";
      
      private static const const_1601:String = "bar_xml";
      
      private static const const_1598:String = "toggle_xml";
      
      private static const const_77:String = "container";
      
      private static const const_1602:String = "wrapper";
      
      private static const const_1597:String = "border";
      
      private static const const_459:String = "list";
      
      private static const const_672:String = "header";
      
      private static const const_671:String = "canvas";
      
      private static const const_1086:String = "icon";
      
      private static const const_1594:String = "button_left";
      
      private static const const_1591:String = "button_right";
      
      private static const const_1600:String = "button_left_page";
      
      private static const const_1590:String = "button_right_page";
      
      private static const const_1593:String = "button_left_end";
      
      private static const const_1587:String = "button_right_end";
      
      private static const const_1331:String = "button_close";
      
      private static const const_1592:String = "button_open";
      
      private static const const_1596:String = "messenger";
      
      private static const const_1087:String = "friendlist";
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_965:IAvatarRenderManager;
      ...
      private var var_1599:ITab;
      
      private var var_1066:int = -1;
      
      private var _startIndex:int = 0;
      
      private var var_1598:TextCropper;
      ...
      public function HabboFriendBarView(param1:HabboFriendBar, param2:uint, param3:IAssetLibrary)
      {
         ...
         this.var_1598 = new TextCropper();
         this.var_98 = new Vector.<ITab>();
         if(param1 is HabboFriendBar)
         {
            this.var_1328 = HabboFriendBar(param1).findFriendsEnabled;
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this._windowManager.getWindowContext(const_458).getDesktopWindow().removeEventListener(WindowEvent.const_40,this.onDesktopResized);
            if(this.var_561)
            {
            ...
            if(this.var_105)
            {
               this.var_105.events.removeEventListener(FriendBarUpdateEvent.const_819,this.onRefreshView);
               this.var_105 = null;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         if(this.var_216)
         {
            this.var_216.visible = !param1;
            if(this.var_49)
            {
               this.var_216.x = this.var_49.x;
               this.var_216.y = this.var_49.y;
      ...
      public function populate() : void
      {
         ...
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_459) as IItemListWindow;
         ...
         var _loc6_:int = this.var_105.numFriends + (!!this.var_1328 ? 1 : 0);
         ...
         if(this.var_1328)
         {
            ...
            {
               _loc11_ = 1;
               if(this.var_98.length + _loc11_ < const_673)
               {
                  _loc11_ = Math.min(_loc10_ - this.var_98.length,const_673 - this.var_98.length);
               }
      ...
      private function onFriendBarDataAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_105.events.addEventListener(FriendBarUpdateEvent.const_819,this.onRefreshView);
         this.var_105.events.addEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
         this.var_105.events.addEventListener(FriendRequestEvent.const_1315,this.onFriendRequestUpdate);
         this.var_105.events.addEventListener(NewMessageEvent.const_1188,this.onNewInstantMessage);
      }
      ...
      private function buildUserInterface() : void
      {
         ...
         Tab.var_1615 = this;
         Tab.var_863 = assets;
         Tab.var_1337 = this._windowManager;
         Tab.var_2112 = this.var_1598;
         var _loc1_:IAsset = assets.getAssetByName(const_1601);
         this.var_49 = this._windowManager.buildFromXML(_loc1_.content as XML,const_458) as IWindowContainer;
         this.var_49.x = const_674;
         this.var_49.y = this.var_49.parent.height - (this.var_49.height + const_1588);
         this.var_49.width = this.var_49.parent.width - (const_674 + const_1088);
         this.var_49.setParamFlag(WindowParam.const_236,true);
         this.var_49.procedure = this.barWindowEventProc;
         if(const_1586)
         {
            _loc1_ = assets.getAssetByName(const_1598);
            this.var_216 = this._windowManager.buildFromXML(_loc1_.content as XML,const_458) as IWindowContainer;
            this.var_216.x = this.var_49.x;
            this.var_216.y = this.var_49.y;
            this.var_216.setParamFlag(WindowParam.const_236,true);
            this.var_216.visible = false;
            this.var_216.procedure = this.toggleWindowEventProc;
         }
         _loc2_ = IWindowContainer(this.var_49.findChildByName(const_1087));
         ...
         this.var_853 = new FriendListIcon(assets,_loc2_.getChildByName(const_1086) as IBitmapWrapperWindow);
         _loc2_ = IWindowContainer(this.var_49.findChildByName(const_1596));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_561 = new MessengerIcon(assets,_loc2_.getChildByName(const_1086) as IBitmapWrapperWindow);
         this.var_561.enable(false);
         this.visible = true;
         this._windowManager.getWindowContext(const_458).getDesktopWindow().addEventListener(WindowEvent.const_40,this.onDesktopResized);
      }
      
      private function onAvatarRendererAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_965 = param2 as IAvatarRenderManager;
      }
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         if(!_loc2_)
         {
            if(this.var_965)
            {
               _loc3_ = this.var_965.createAvatarImage(param1,AvatarScaleType.const_58,null,this);
               if(_loc3_)
               {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = null;
         var _loc3_:IItemListWindow = this.var_49.findChildByName(const_459) as IItemListWindow;
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            if(_loc2_.figure == param1)
            {
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = _loc7_.getChildByName(const_459) as IItemListWindow;
                     if(_loc8_)
                     {
                        _loc9_ = IWindowContainer(_loc8_.getListItemByName(const_672));
                        if(_loc9_)
                        {
                           _loc10_ = _loc9_.findChildByName(const_671) as IBitmapWrapperWindow;
      ...
      private function onFindFriendsNotification(param1:FindFriendsNotificationEvent) : void
      {
         ...
         {
            param1.dispose();
         },HabboAlertDialogFlag.const_515);
      }
      ...
      private function onFriendRequestUpdate(param1:FriendRequestEvent) : void
      {
         if(this.var_853)
         {
            this.var_853.notify(this.var_105.numFriendRequests > 0);
         }
      }
      ...
      private function barWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_43)
         {
            ...
            _loc4_ = this.var_105.numFriends + (!!this.var_1328 ? 1 : 0);
            switch(param2.name)
            {
               case const_1594:
         ...
         if(param1.type == WindowEvent.const_528)
         {
            this.deSelect();
         }
      }
      ...
      {
         var _loc2_:Icon = param1.window.name == const_1087 ? this.var_853 : this.var_561;
         switch(param1.type)
         {
      ...
      private function toggleArrowButtons(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:IWindowContainer = this.var_49.findChildByName(const_1602) as IWindowContainer;
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1595,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            _loc4_.visible = param1;
         }
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1599,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param2)
            {
         ...
         if(!disposed)
         {
            if(this.var_49)
            {
               ...
               if(!param1)
               {
                  ...
                  {
                     if(this.var_98.length < const_673)
                     {
                        param1 = true;
                     }
                     else if(this.var_98.length < this.var_105.numFriends + (!!this.var_1328 ? 1 : 0))
                     {
                        param1 = true;
                     }
      ...
      private function get maxNumOfTabsVisible() : int
      {
         ...
         return (_loc1_.width - _loc4_) / (const_1603 + _loc3_.spacing);
      }
