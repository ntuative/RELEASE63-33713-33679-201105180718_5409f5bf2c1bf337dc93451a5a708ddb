package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_296:Boolean = false;
      
      private static const const_644:String = "Navigation";
      
      private static const const_643:String = "Friend Bar";
      
      private static const const_1371:String = "go.friendbar";
      
      private static const const_1374:String = "chat_btn_click";
      
      private static const const_1370:String = "find_friends_btn_click";
      
      private static const const_1007:String = "Toolbar";
      
      private static const const_1005:String = "open";
      
      private static const const_1006:String = "close";
      
      private static const const_1373:String = "FRIENDLIST";
      
      private static const const_1372:String = "MESSENGER";
       
      
      private var var_86:IHabboCommunicationManager;
      
      private var var_302:IHabboFriendList;
      
      private var var_421:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_302)
            {
               this.var_302.release(new IIDHabboFriendList());
               this.var_302 = null;
            }
            if(this.var_421)
            {
               this.var_421.release(new IIDHabboMessenger());
               this.var_421 = null;
            }
            this.var_136 = null;
      ...
      {
         return this.var_301.getValue(param1);
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_86)
         {
            ...
            this.var_86.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_644,const_643,const_1371));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_421)
         {
            this.var_421.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false));
            if(this.var_86)
            {
               this.var_86.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_644,const_643,const_1374));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_86)
         {
            ...
            this.var_86.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_644,const_643,const_1370));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_302)
         {
            if(!this.var_302.disposed)
            {
               if(!this.var_302.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_302.openFriendRequests();
                  }
                  else
                  {
                     this.var_302.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_302.mainWindow;
               ...
               if(this.var_86)
               {
                  this.var_86.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1007,const_1373,!!this.var_302.isOpen() ? const_1005 : const_1006));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_421)
         {
            if(!this.var_421.disposed)
            {
               this.var_421.toggleMessenger();
               if(this.var_86)
               {
                  this.var_86.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1007,const_1372,!!this.var_421.isOpen() ? const_1005 : const_1006));
               }
            }
         }
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_301.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_301.remove(_loc8_);
               this.var_136.splice(this.var_136.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_301.getValue(_loc4_.id);
            if(_loc3_)
            {
               if(_loc4_.online || const_296)
               {
               ...
               {
                  this.var_301.remove(_loc4_.id);
                  this.var_136.splice(this.var_136.indexOf(_loc3_),1);
               }
            }
            else if(_loc4_.online || const_296)
            {
               ...
               this.var_301.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_296)
            {
               if(this.var_301.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
                  this.var_136.push(_loc3_);
                  this.var_301.add(_loc3_.id,_loc3_);
         ...
         {
            this.var_136 = !!const_296 ? this.sortByNameAndOnlineStatus(this.var_136) : this.sortByName(this.var_136);
         }
