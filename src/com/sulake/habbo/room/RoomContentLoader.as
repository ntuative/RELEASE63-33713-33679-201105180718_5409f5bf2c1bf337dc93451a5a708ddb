package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_849:String = "RCL_LOADER_READY";
      
      private static const const_363:String = "RCL_PUBLICROOM_";
      
      private static const const_1924:int = 0;
      
      private static const const_996:int = 1;
      
      private static const name_4:int = 2;
      
      private static const const_444:String = "place_holder";
      
      private static const const_638:String = "wall_place_holder";
      
      private static const const_640:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_444;
      
      private static const const_639:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_995:String = "selection_arrow";
      ...
      private var var_1387:IEventDispatcher = null;
      ...
      private var var_887:Map = null;
      
      private var var_201:PublicRoomData = null;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2272 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2274 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_996)
         {
            return;
         }
         this.var_1387 = param1;
         this.var_2275 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2271 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initPetData() : void
      {
         ...
         for each(_loc3_ in _loc1_)
         {
            ...
            this.var_886.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_358.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_492 != null)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_492.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(this.var_413 != null)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_413.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_716.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
      ...
      private function continueInitilization() : void
      {
         if(this.var_2273)
         {
            ...
            {
               this.var_1387.dispatchEvent(new Event(const_849));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_494 != null)
         {
            this.var_494.remove(param1);
            this.var_494.add(param1,param2);
         }
         if(this.var_493 != null)
         {
            this.var_493.remove(param2);
            this.var_493.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_494 != null)
         {
            _loc2_ = this.var_494.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_493 != null)
         {
            _loc2_ = this.var_493.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_201 != null && (this.var_201.type == param1 || this.var_201.hasWorldType(param1)))
         {
         ...
         {
            return RoomObjectCategoryEnum.const_353;
         }
         return RoomObjectCategoryEnum.const_171;
      }
      ...
      {
         return [const_444,const_638,const_640,const_639,TILE_CURSOR,const_995];
      }
      ...
      {
         return this.var_886.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_887[param1];
         if(_loc3_ != null)
         {
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_716.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_201 != null && this.var_201.hasWorldType(const_363 + param1))
         {
            return this.var_201.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_260 || param1 == RoomObjectVisualizationEnum.const_56 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            this.var_201 = this.var_1388.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_930,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2272.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1731);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2274.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_887.add(_loc6_,_loc3_);
         }
      }
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_717.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_717.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_492.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_717.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_492.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_492.add(_loc5_,_loc4_);
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_413.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_413.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_413[_loc2_] != null)
         {
            _loc3_ = this.var_413.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      {
         if(this.getObjectCategory(const_363 + param1) == RoomObjectCategoryEnum.const_83)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_201.getWorldHeightScale(const_363 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_201 != null)
         {
            return this.var_201.getWorldScale(const_363 + param1);
         }
         return 32;
      }
