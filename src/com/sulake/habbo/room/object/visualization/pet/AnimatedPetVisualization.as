package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1579:String = "head";
      
      private static const const_670:int = 1;
      
      private static const const_1079:int = 1000;
      
      private static const const_1581:String = "pet_experience_bubble_png";
      ...
      public function AnimatedPetVisualization()
      {
         ...
         this.var_1054 = [];
         super();
         while(this.var_127.length < ANIMATION_INDEX_COUNT)
         {
            this.var_127.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_127 != null)
         {
            ...
            {
               _loc2_ = this.var_127[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1581) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_400 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_283);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_164);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_283);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_164);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_1780 = _loc3_.getNumber(RoomObjectVariableEnum.const_419) > 0;
            ...
            {
               this.var_2050 = direction;
            }
            this.var_1423 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2219 = _loc3_.getNumber(RoomObjectVariableEnum.const_874);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_787);
            if(_loc9_ != this.var_2049)
            {
               this.var_2049 = _loc9_;
               this.var_2857 = this.var_2049.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_400 != null)
         {
            ...
            if(this.var_1423 > 0)
            {
               ...
               if(_loc2_ < const_1079)
               {
                  this.var_400.alpha = int(Math.sin(_loc2_ / const_1079 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_400.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_400.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_670;
      }
      ...
      {
         var _loc2_:* = null;
         if(param1 >= 0 && param1 < this.var_127.length)
         {
      ...
      override protected function resetAllAnimationFrames() : void
      {
         var _loc2_:* = null;
         this.var_1588 = false;
         var _loc1_:int = this.var_127.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_127[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_127.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_127[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2857);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_670)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_670))
            {
               if(param2 >= FurnitureVisualizationData.const_479.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_479[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2050);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_93,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1579)
            {
               this.var_1054[param1] = true;
            }
            else
            {
               this.var_1054[param1] = false;
            }
         }
