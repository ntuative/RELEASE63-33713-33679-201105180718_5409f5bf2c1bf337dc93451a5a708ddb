package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_802:IGraphicAssetCollection;
      
      private var var_1983:XMLList;
      ...
      private var var_1150:Point = null;
      
      private var var_1433:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_917)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1433 = this.var_45.getValue(this.var_917);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2389 = new Vector3d(-0.5,0.5,0);
         this.var_918 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2389);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1150.x = _loc3_.x;
         this.var_1150.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_45.getValue(this.var_917);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1750 = RoomObjectVariableEnum.const_1164;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1750 = RoomObjectVariableEnum.const_1248;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1151 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1151 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_45.getValue(this.var_917);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2390 && param3 == this.var_2388)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1151 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1151 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1750);
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1433.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_802.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1150.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1150.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_423.indexOf(_loc10_) >= 0 && this.var_918)
            {
               param1 = this.var_423.indexOf(_loc10_);
               if(this.var_604[param1] != "")
               {
                  _loc9_ = this.var_802.getAsset(this.var_604[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
      ...
      {
         this.var_918 = true;
         var _loc3_:int = this.var_423.indexOf(param1);
         if(_loc3_ < 0)
         {
