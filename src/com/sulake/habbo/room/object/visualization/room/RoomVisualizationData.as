package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_497:FloorRasterizer;
      
      private var var_719:WallAdRasterizer;
      
      private var var_498:LandscapeRasterizer;
      
      private var var_720:PlaneMaskManager;
      ...
      public function RoomVisualizationData()
      {
         ...
         this.var_497 = new FloorRasterizer();
         this.var_719 = new WallAdRasterizer();
         this.var_498 = new LandscapeRasterizer();
         this.var_720 = new PlaneMaskManager();
      }
      ...
      public function initialize(param1:XML) : Boolean
      {
         ...
         {
            _loc8_ = _loc3_[0];
            this.var_497.initialize(_loc8_);
         }
         ...
         {
            _loc10_ = _loc5_[0];
            this.var_498.initialize(_loc10_);
         }
         var _loc6_:XMLList = param1.maskData;
         if(_loc6_.length() > 0)
         {
            _loc11_ = _loc6_[0];
            this.var_720.initialize(_loc11_);
         }
         return true;
      }
