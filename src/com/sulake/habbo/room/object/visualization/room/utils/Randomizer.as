package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2093:int = 1;
      
      public static const const_2137:int = 16777216;
      ...
      private var var_2024:int = 16777216;
      
      private var var_2963:int = 69069;
      
      private var var_2962:int = 5;
      ...
      {
         var _loc1_:int = this.var_2963 * this.var_2023 + this.var_2962;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_2024;
         this.var_2023 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_2024 * param2);
      }
   }
}
