package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1633:int = 16777215;
      
      public static const const_1900:int = 13421772;
      
      private static const const_1051:int = 16777215;
      
      private static const const_1053:int = 13421772;
      
      private static const const_1052:int = 10066329;
      
      private static const const_1050:int = 10066329;
      
      public static const const_1778:int = 16777215;
      
      public static const const_1689:int = 13421772;
      
      public static const const_1802:int = 10066329;
      ...
      private var var_804:Rectangle = null;
      ...
      private var var_1506:Number = NaN;
      
      private var var_1916:String = null;
      
      private var var_1237:uint = 16777215;
      
      private var var_2641:int = 255;
      
      private var var_2645:int = 255;
      
      private var var_2642:int = 255;
      
      private var var_1917:Boolean = true;
      
      private var var_1238:int = 0;
      
      private var var_2034:int = -1000;
      
      private const const_2227:int = 250;
      
      private var var_1639:int = -1;
      
      private var var_1604:Number = 0.0;
      
      private var var_2644:Number = 0.0;
      
      private var var_2643:Number = 0.0;
      
      private var var_1918:Number = 0.0;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_804 = super.boundingRectangle;
         }
         return new Rectangle(this.var_804.x,this.var_804.y,this.var_804.width,this.var_804.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1506))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1506;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1291);
         ...
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_246)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1633;
               }
               else
               {
                  _loc13_.color = const_1900;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_375)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1778;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1689;
               }
               else
               {
                  _loc13_.color = const_1802;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1878)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_70,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_2034 + this.const_2227 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_368.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1917)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2642 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2645 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2641 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1639)
         {
            this.var_1639 = param1.updateId;
            this.var_804 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1604 || _loc3_.y != this.var_2644 || _loc3_.z != this.var_2643 || param1.scale != this.var_1918))
            {
               this.var_1604 = _loc3_.x;
               this.var_2644 = _loc3_.y;
               this.var_2643 = _loc3_.z;
               this.var_1918 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1218);
            if(_loc3_ != this.var_1916)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1916 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_777));
            if(_loc4_ != this.var_1237)
            {
               this.var_1237 = _loc4_;
               this.var_2642 = this.var_1237 & 255;
               this.var_2645 = this.var_1237 >> 8 & 255;
               this.var_2641 = this.var_1237 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1307));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_153 != param1.getUpdateID())
         {
            ...
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_972));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_927));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_153 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1133);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1237);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1506))
            {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1238;
      }
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_70 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_265)
                              {
