package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1270:Vector3d = null;
      ...
      private var var_1016:IPlaneRasterizer = null;
      
      private var var_720:PlaneMaskManager = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_1270 = new Vector3d();
         this.var_1270.assign(param1);
         ...
         this.var_2738 = param12;
         this.var_1015 = param6;
      }
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_665);
                  return param1;
               }
            }
         }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1016.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_828 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_386))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_1016 != null)
            {
               _loc3_ = this.var_1016.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1979,this.var_2740,this.var_2739,this.var_2736,this.var_2738,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1639 != geometry.updateId)
         {
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1521.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1521[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1270);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_170.z - originZ,this.var_124.z - originZ,this.var_89.z - originZ,this.var_125.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2737 = relativeDepth;
            this._isVisible = true;
            this.var_1639 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2735);
      ...
      {
         this.var_170.assign(param1.getScreenPosition(this.var_96));
         this.var_124.assign(param1.getScreenPosition(Vector3d.sum(this.var_96,this.var_330)));
         this.var_89.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_96,this.var_329),this.var_330)));
         this.var_125.assign(param1.getScreenPosition(Vector3d.sum(this.var_96,this.var_329)));
         this._offset = param1.getScreenPoint(this.var_1270);
         ...
         var _loc2_:Number = Math.min(this.var_170.x,this.var_124.x,this.var_89.x,this.var_125.x);
         var _loc3_:Number = Math.max(this.var_170.x,this.var_124.x,this.var_89.x,this.var_125.x);
         var _loc4_:Number = Math.min(this.var_170.y,this.var_124.y,this.var_89.y,this.var_125.y);
         var _loc5_:Number = Math.max(this.var_170.y,this.var_124.y,this.var_89.y,this.var_125.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_170 == null || this.var_124 == null || this.var_89 == null || this.var_125 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
         var _loc3_:Number = this.var_125.x - this.var_89.x;
         var _loc4_:Number = this.var_125.y - this.var_89.y;
         var _loc5_:Number = this.var_124.x - this.var_89.x;
         var _loc6_:Number = this.var_124.y - this.var_89.y;
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_273.length == this.var_1014.length)
         {
         ...
         if(this.var_385.length > this.var_1546.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1015 || this.var_273.length == 0 && this.var_385.length == 0 && !this.var_386 || this.var_720 == null)
         {
            return;
         }
         ...
         if(this.var_386)
         {
            ...
            while(_loc5_ < this.var_273.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_71.width - this.var_71.width * _loc3_.leftSideLoc / this.var_329.length;
                  _loc11_ = this.var_71.height - this.var_71.height * _loc3_.rightSideLoc / this.var_330.length;
                  _loc12_ = _loc3_.type;
                  this.var_720.updateMask(this.var_71,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_385.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_71.width - this.var_71.width * _loc4_.leftSideLoc / this.var_329.length;
                  _loc11_ = this.var_71.height - this.var_71.height * _loc4_.rightSideLoc / this.var_330.length;
                  _loc13_ = this.var_71.width * _loc4_.leftSideLength / this.var_329.length;
                  _loc14_ = this.var_71.height * _loc4_.rightSideLength / this.var_330.length;
                  this.var_71.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1546.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_386 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_235.copyChannel(param1,param1.rect,const_665,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_235.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_235,this.var_235.rect,const_665,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
