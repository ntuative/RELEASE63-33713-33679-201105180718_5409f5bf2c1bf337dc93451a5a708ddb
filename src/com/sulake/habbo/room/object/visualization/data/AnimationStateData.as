   ...
   public class AnimationStateData
   {
      ...
      public function resetAnimationFrames(param1:Boolean = true) : void
      {
         ...
         while(_loc2_ < this.var_596)
         {
            ...
            this.var_901[_loc2_] = false;
            this.var_902[_loc2_] = false;
            _loc2_++;
         }
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_596)
         {
