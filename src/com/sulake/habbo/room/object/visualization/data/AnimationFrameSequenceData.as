package com.sulake.habbo.room.object.visualization.data
{
   public class AnimationFrameSequenceData
   {
      ...
      {
         return this.var_433.length * this._loopCount;
      }
      ...
      public function initialize() : void
      {
         var _loc1_:int = 1;
         var _loc2_:int = -1;
         var _loc3_:int = this.var_433.length - 1;
         while(_loc3_ >= 0)
         {
            if(this.var_433[_loc3_] == _loc2_)
            {
               _loc1_++;
            }
            else
            {
               _loc2_ = this.var_433[_loc3_];
               _loc1_ = 1;
            }
      ...
      public function addFrame(param1:int, param2:int, param3:int, param4:int, param5:int, param6:DirectionalOffsetData) : void
      {
         ...
         this.var_433.push(this._frames.length - 1);
         this.var_900.push(1);
      }
      ...
      public function getFrame(param1:int) : AnimationFrameData
      {
         ...
         param1 = this.var_433[param1 % this.var_433.length];
      ...
      public function method_1(param1:int) : int
      {
         ...
         if(this.var_1839)
         {
            param1 = Math.random() * this.var_433.length;
            if(param1 == this.var_433.length)
            {
               param1--;
            }
         }
