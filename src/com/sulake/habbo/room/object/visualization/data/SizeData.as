package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_408:int = 1000;
      ...
      private var var_1479:int = 360;
      
      private var var_781:DirectionData = null;
      
      private var var_261:Map;
      
      private var _colors:Map;
      
      private var var_1199:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_781 = new DirectionData(param1);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_261 != null)
         {
            ...
            {
               _loc2_ = this.var_261.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_781,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_261.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_781);
            this.defineDirection(_loc3_,_loc8_);
            this.var_261.add(String(_loc7_),_loc3_);
            this.var_1836 = -1;
            this.var_1199 = null;
            _loc5_++;
         }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         while(_loc4_ < param2.length())
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc6_,LayerData.const_1126);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1235);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1479 / 2) % 360 / this.var_1479;
         if(this.var_261.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_261.getKey(_loc5_)) * this.var_1479;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_261.getKey(_loc4_));
         }
         return const_1625;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_261.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_781;
         }
