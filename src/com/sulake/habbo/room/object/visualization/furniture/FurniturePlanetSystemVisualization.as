package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      public function FurniturePlanetSystemVisualization()
      {
         ...
         this.var_2179 = new Vector3d(0,0,0);
         super();
      }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         if(this.var_247 == null && spriteCount > 0)
         {
         ...
         if(this.var_247 != null)
         {
            ...
            {
               _loc2_ = this.var_247[_loc3_];
               _loc2_.update(this._offsetArray,this.var_2179,param1);
               _loc3_++;
            }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1290);
