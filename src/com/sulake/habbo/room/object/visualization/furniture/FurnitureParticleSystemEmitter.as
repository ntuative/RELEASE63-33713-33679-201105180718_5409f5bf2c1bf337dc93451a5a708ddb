package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1629:String = "cone";
      
      public static const const_1644:String = "plane";
      
      public static const const_1685:String = "sphere";
      ...
      public function setup(param1:int, param2:int, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:String, param8:Number, param9:int, param10:int) : void
      {
         ...
         this.var_274 = param6;
         this.var_2748 = param7;
         this.var_2746 = param9;
         this._energy = param8;
      ...
      public function reset() : void
      {
         ...
         this.var_1018 = 0;
         this.var_957 = false;
         this.init(0,0,0,this._direction,this.var_2749,this.var_1019,this.var_2746,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1272.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_957 = true;
         if(this.var_1018 < this.var_1548)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2747)
         {
            switch(this.var_2748)
            {
               case const_1629:
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1272.length);
         return this.var_1272[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1018 < this.var_1548)
         {
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1018 < this.var_1548)
         {
            ...
            this.y = (2 - this.var_274) * this.y - (1 - this.var_274) * this.lastY + this.var_1987 * this.var_1019 * this.var_1019;
         ...
         for each(_loc2_ in this.var_389)
         {
            ...
            _loc2_.y = (2 - this.var_274) * _loc2_.y - (1 - this.var_274) * _loc2_.lastY + this.var_1987 * this.var_1019 * this.var_1019;
