package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            this.var_767[0] = this.getNewPoint(param1,0);
         }
         _loc2_ = getSprite(3);
         if(_loc2_ != null)
         {
            this.var_767[1] = this.getNewPoint(param1,1);
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            if(this.var_767.length == 2)
            {
               return this.var_767[param3 - 2].x;
            }
         }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         if(param3 == 2 || param3 == 3)
         {
            if(this.var_767.length == 2)
            {
               return this.var_767[param3 - 2].y;
            }
         }
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1181[param2];
         var _loc4_:int = this.var_1179[param2];
         var _loc5_:int = this.var_1180[param2];
         var _loc6_:Number = this.var_1182[param2];
         if(param1 == 32)
         {
            _loc7_ = const_1021;
         }
         ...
         this.var_1181[param2] = _loc3_;
         if(int(_loc9_) == 0)
         {
            this.var_1182[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1181.push(Math.random() * _loc2_ * 1.5);
         this.var_1181.push(Math.random() * _loc2_ * 1.5);
         this.var_1179 = new Array();
         this.var_1179.push(1);
         this.var_1179.push(-1);
         this.var_1180 = new Array();
         this.var_1180.push(const_1404);
         this.var_1180.push(const_1403);
         this.var_1182 = new Array();
         this.var_1182.push(this.getRandomAmplitudeFactor());
         this.var_1182.push(this.getRandomAmplitudeFactor());
      }
