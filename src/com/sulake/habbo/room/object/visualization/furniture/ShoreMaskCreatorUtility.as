package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      {
         return param1 + param2 * const_1561;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_151,const_82,const_69,const_151,const_82,const_69];
                     _loc8_ = [const_82,const_82,const_82,const_69,const_69,const_69];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
      ...
      private static function storeLeftMask(param1:IGraphicAssetCollection, param2:BitmapData, param3:int, param4:int, param5:int) : void
      {
         ...
         if(param1 != null)
         {
            ...
            param1.addAsset(_loc6_,Rasterizer.method_5(param2),false);
