package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1441:String = "shore";
      ...
      {
         if(this.var_2587 == param1 && this.var_2586 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1441)
            {
               this.var_1853 = _loc2_;
               this.var_2587 = param1;
               this.var_2586 = direction;
               return this.var_1853;
            }
            _loc2_--;
         }
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1854 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_436.length)
         {
            if(this.var_436[_loc5_] == true)
            {
               this.var_1854 = true;
            }
            _loc5_++;
      ...
      {
         var _loc2_:* = null;
         if(this.var_526 == 0 || this.var_636 == 0)
         {
            ...
            this.var_526 = _loc2_.getNumber(RoomObjectVariableEnum.const_311);
            this.var_636 = _loc2_.getNumber(RoomObjectVariableEnum.const_405);
         }
         this.var_436 = [];
         this.var_637 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_526 * 2 + this.var_636 * 2)
         {
            this.var_436.push(false);
            this.var_637.push(ShoreMaskCreatorUtility.const_82);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_71,getSize(param3),this.var_436,this.var_637,assetCollection);
      }
