package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      {
         if(param1 != this.var_2903)
         {
            if(!param1)
            {
               this.var_329.assign(this.var_856);
               this.var_330.assign(this.var_857);
            }
            else
            {
               this.var_329.assign(this.var_856);
               this.var_329.mul(this.var_857.length / this.var_856.length);
               this.var_330.assign(this.var_857);
               this.var_330.mul(this.var_856.length / this.var_857.length);
            }
            this.var_1639 = -1;
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_96 == null && this.var_1270 != null || this.var_329 == null || this.var_330 == null || this._normal == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1639)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1604 || _loc4_.y != this.var_2644 || _loc4_.z != this.var_2643 || param1.scale != this.var_1918))
            {
               this.var_1604 = _loc4_.x;
               this.var_2644 = _loc4_.y;
               this.var_2643 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_1270);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_170.z - _loc7_,this.var_124.z - _loc7_,this.var_89.z - _loc7_,this.var_125.z - _loc7_);
               this.var_2737 = _loc8_;
