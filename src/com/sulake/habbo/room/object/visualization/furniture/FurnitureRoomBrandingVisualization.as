package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1454:int = 2;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(!this.var_1354)
         {
            this.var_1354 = this.checkIfImageReady();
            if(this.var_1354)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
      ...
      protected function checkIfImageChanged() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_357);
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_568);
                     if(_loc4_ == 1)
                     {
