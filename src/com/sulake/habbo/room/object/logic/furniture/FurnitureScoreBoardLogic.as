   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_855 != _loc2_)
         {
            ...
            if(_loc3_ * const_460 > const_1090)
            {
               this.var_1051 = const_1090 / _loc3_;
            }
            else
            {
               this.var_1051 = const_460;
            }
            this.var_1602 = getTimer();
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_855 && param1 >= this.var_1602 + this.var_1051)
            {
               _loc3_ = param1 - this.var_1602;
               _loc4_ = _loc3_ / this.var_1051;
               _loc5_ = 1;
               if(this.var_855 < _loc2_)
               {
                  _loc5_ = -1;
               ...
               this.var_1602 = param1 - (_loc3_ - _loc4_ * this.var_1051);
            }
         }
      }
   }
