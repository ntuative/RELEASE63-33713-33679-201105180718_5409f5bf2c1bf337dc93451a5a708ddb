package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1409:String = "goawaybus";
      
      private static const const_1408:String = "bus";
      
      private static const const_1410:String = "bus_oviopen_hidden";
      ...
      {
         var _loc1_:Array = [RoomObjectRoomActionEvent.const_622,RoomObjectRoomActionEvent.const_525];
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  case const_1409:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_622,0,_loc4_,_loc5_);
                     break;
                  case const_1408:
                  case const_1410:
