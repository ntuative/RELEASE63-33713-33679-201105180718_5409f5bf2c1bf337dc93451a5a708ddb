package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1400:uint = 16777215;
      
      private var var_1699:int = 255;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_621,RoomObjectMouseEvent.const_149];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1291,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_777,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_830,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_972,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_927,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1117)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1700;
            if(_loc2_ - this.var_1117 >= this.var_1698)
            {
               _loc3_ = this.var_1116;
               _loc4_ = this.var_1701;
               this.var_1117 = 0;
            }
            else
            {
               _loc7_ = this.var_1400 >> 16 & 255;
               _loc8_ = this.var_1400 >> 8 & 255;
               _loc9_ = this.var_1400 & 255;
               _loc10_ = this.var_1116 >> 16 & 255;
               _loc11_ = this.var_1116 >> 8 & 255;
               _loc12_ = this.var_1116 & 255;
               _loc13_ = (_loc2_ - this.var_1117) / this.var_1698;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1699 + (this.var_1701 - this.var_1699) * _loc13_;
               this._color = _loc3_;
               this.var_1700 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_777,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_739:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_954:
               param2.setString(RoomObjectVariableEnum.const_218,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_868:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_562:
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_895:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1218,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1318:
               param2.setNumber(RoomObjectVariableEnum.const_830,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1269:
               param2.setNumber(RoomObjectVariableEnum.const_972,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_927,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1089:
               param2.setNumber(RoomObjectVariableEnum.const_1133,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1238:
               param2.setNumber(RoomObjectVariableEnum.const_1237,param1.value);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1307,int(param1.bgOnly));
         this.var_1400 = this._color;
         this.var_1699 = this.var_1700;
         this.var_1116 = _loc3_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_545,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1610,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1676,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1632,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_545,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_288 || _loc12_ == RoomPlaneData.const_375)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
