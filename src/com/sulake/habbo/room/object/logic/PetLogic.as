package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_149,RoomObjectMoveEvent.const_440];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2391)
         {
            ...
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1435 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
            {
               _loc6_ = param1 as RoomObjectAvatarPetGestureUpdateMessage;
               _loc2_.setString(RoomObjectVariableEnum.const_164,_loc6_.gesture);
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_419,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_874,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1768,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_787,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(param1.type)
         {
            case MouseEvent.CLICK:
               ...
               if(eventDispatcher != null)
               {
                  _loc8_ = new RoomObjectMouseEvent(RoomObjectMouseEvent.const_149,param1.eventId,_loc6_,_loc7_,param1.altKey,param1.ctrlKey,param1.shiftKey,param1.buttonDown);
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_215,_loc3_ + this.var_920);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1752;
            _loc2_.setNumber(RoomObjectVariableEnum.const_283,this.var_1752);
            _loc2_.setNumber(RoomObjectVariableEnum.const_164,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1753;
            _loc2_.setNumber(RoomObjectVariableEnum.const_164,this.var_1753);
         }
         else
         {
            this.var_920 += 45;
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         ...
         {
            param2.setString(RoomObjectVariableEnum.const_164,null);
            this.var_1436 = 0;
         }
         if(this.var_1435 > 0)
         {
