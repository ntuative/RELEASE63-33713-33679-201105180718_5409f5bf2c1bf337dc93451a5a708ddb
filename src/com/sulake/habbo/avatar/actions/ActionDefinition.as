package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2835 = parseInt(param1.@precedence);
         this.var_2834 = String(param1.@activepartset);
         this.var_2833 = String(param1.@assetpartdefinition);
         this.var_2832 = String(param1.@lay);
         this.var_813 = String(param1.@geometrytype);
         this.var_2416 = Boolean(parseInt(param1.@main));
         this.var_2838 = Boolean(parseInt(param1.@method_8));
         this.var_2837 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2836 = _loc6_;
            }
            else
            {
               this.var_2031[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_843.add(param1,new Map());
         }
         var _loc4_:Map = this.var_843.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_843.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_2031[param1];
         if(_loc2_ == null)
         {
