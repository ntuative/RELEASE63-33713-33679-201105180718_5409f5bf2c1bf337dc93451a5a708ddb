   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_68,FigureData.const_203,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_68,FigureData.const_286,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_68,FigureData.const_234,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_68,FigureData.const_285,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_68,FigureData.const_292,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_68 && var_154 == "")
         {
            var_68.switchCategory(FigureData.const_203);
         }
      }
