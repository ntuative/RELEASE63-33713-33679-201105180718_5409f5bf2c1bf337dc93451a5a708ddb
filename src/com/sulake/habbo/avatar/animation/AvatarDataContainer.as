package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1709 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2315 = parseInt(_loc2_,16);
         this.var_2316 = parseInt(_loc3_,16);
         ...
         this.var_839 = new ColorTransform(this.var_1869,this.var_1871,this.var_1872,this._alphaMultiplier);
         this.var_1124 = this.generatePaletteMapForGrayscale(this.var_2316,this.var_2315);
      }
      ...
      {
         return this.var_1124.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1124.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1124.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1124.getValue("alphas") as Array;
      }
