package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private const const_2212:int = 100;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         this.var_941 = new Timer(this.const_2212,1);
         this.var_941.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_942);
            if(this.var_1461.indexOf("?") > 0)
            {
               _loc2_ = this.var_1461 + "&retry=" + this.var_942;
            }
            else
            {
               _loc2_ = this.var_1461 + "?retry=" + this.var_942;
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2495,this._assets);
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_943)
         {
            _loc7_ = true;
            _loc4_ = this.var_943[_loc3_];
      ...
      {
         var _loc1_:* = null;
         while(this.var_770.length > 0 && this.var_771.length < this.const_1776)
         {
