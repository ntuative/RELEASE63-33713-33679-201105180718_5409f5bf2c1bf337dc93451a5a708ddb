package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_265:AvatarImageCache;
      
      private var var_644:int = 0;
      
      private var var_1719:int = 0;
      
      private var var_587:AvatarFigureContainer;
      
      private var var_643:Boolean;
      
      private var var_209:Array;
      
      private var var_570:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_587 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_587.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1410 = this.var_1105;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_52)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1410);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_587,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1410 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.method_1(this.var_644);
                  _loc20_ = this.var_92;
                  _loc21_ = 1;
                  switch(this.var_92)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_587,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_92)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.method_1(this.var_644);
                  _loc21_ = this.var_92;
                  _loc22_ = 1;
                  switch(this.var_92)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_533 = this.var_533 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_380:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1636:
                  case AvatarAction.const_1841:
                  case AvatarAction.const_1230:
                  case AvatarAction.const_1316:
                  case AvatarAction.const_1624:
                  case AvatarAction.const_1682:
      ...
      private function sortActions() : void
      {
         ...
         this.var_1408 = this._structure.sortActions(this.var_336);
         ...
         {
            this.var_843 = this._structure.getCanvasOffsets(this.var_1408,this._scale,this.var_92);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1408)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_418)
               {
                  this.var_905 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1105 = _loc4_.id;
                     this.var_1677 = _loc4_.breed;
                     break;
                  }
               }
            }
