package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this._state = name_3;
         this._assets = param4;
         this.var_919 = String(param1);
         this._revision = String(param2);
         this.var_1434 = param3 + this.var_919 + ".swf";
         this.var_1434 = this.var_1434.replace("%revision%",this._revision);
         var _loc5_:AssetLibraryCollection = this._assets as AssetLibraryCollection;
         var _loc6_:IAssetLibrary = _loc5_.getAssetLibraryByUrl(this.var_919 + ".swf");
         if(_loc6_ != null)
         {
            Logger.log("[AvatarAssetDownloadLibrary] Already Downloaded by Core: " + this.var_919);
            this._state = name_4;
         }
      }
      ...
      public function startDownloading() : void
      {
         ...
         var _loc1_:URLRequest = new URLRequest(this.var_1434);
      ...
      {
         var _loc1_:String = this.var_919;
