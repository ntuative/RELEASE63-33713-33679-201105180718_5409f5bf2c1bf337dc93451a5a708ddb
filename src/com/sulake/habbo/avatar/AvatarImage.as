package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_2050:int;
      
      protected var var_285:IActiveActionData;
      
      protected var var_1088:Boolean;
      
      protected var var_843:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_265:AvatarImageCache;
      
      protected var var_587:AvatarFigureContainer;
      
      protected var var_570:IAvatarDataContainer;
      ...
      protected var var_1352:Boolean = false;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_587 = param3;
         this.var_265 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1363,const_1365);
         this.var_336 = new Array();
         this.var_904 = new ActiveActionData(AvatarAction.const_421);
         this.var_904.definition = this._structure.getActionDefinition(const_1364);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_587,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1719;
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_264.length == 1 && this.var_92 == this.var_2050)
         {
            return this.var_92 + this.var_533 + this.var_644 % 4;
         }
      ...
      {
         if(param3 != this.var_2604 || param2 != this.var_2605 || param1 != this.var_2606)
         {
            this.var_2604 = param3;
            this.var_2605 = param2;
            this.var_2606 = param1;
            this.var_1889 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1352 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1352)
            {
               this.var_47.dispose();
            }
         ...
         {
            if(this.var_570.paletteIsGrayscale)
            {
               ...
               this.var_47 = _loc13_;
               this.var_47.paletteMap(this.var_47,this.var_47.rect,new Point(0,0),this.var_570.reds,[],[]);
            }
            else
            {
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_336.push(new ActiveActionData(param1,param2,this.var_644));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_285 = this.var_904;
         this.var_285.definition = this.var_904.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_533 = "";
         this.var_264 = this._structure.sortActions(this.var_336);
         if(this.var_264 == null)
         {
            this.var_843 = new Array(0,0,0);
            if(this.var_1224 != "")
            {
               _loc1_ = true;
               this.var_1224 = "";
         ...
         {
            this.var_843 = this._structure.getCanvasOffsets(this.var_264,this._scale,this.var_92);
            for each(_loc4_ in this.var_264)
            {
               this.var_533 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_346)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1496 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1224 != this.var_533)
            {
               _loc1_ = true;
               this.var_1224 = this.var_533;
            }
         }
         this.var_1409 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_264)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_905 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1719 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_570 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_304 || _loc1_.actionType == AvatarAction.const_273 || _loc1_.actionType == AvatarAction.const_418)
               {
                  this.var_905 = true;
               }
            }
