package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1049:AvatarActionManager;
      ...
      private var var_845:AnimationManager;
      
      private var var_904:ActionDefinition;
      
      private var var_556:String;
      
      private var var_1583:PartOffsetData;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         ...
         this.var_466 = new PartSetsData();
         this._animationData = new AnimationData();
         this.var_845 = new AnimationManager();
         this.var_556 = param2;
      ...
      {
         this.var_1583.loadOffsets(param1);
      }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_1049 = new AvatarActionManager(param1,this.var_556,param2);
         this.var_904 = this.var_1049.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         ...
         if(this.var_466.parse(param1))
         {
            if(this.var_556 == AvatarType.const_130)
            {
               this.var_466.getPartDefinition("ri").appendToFigure = true;
               this.var_466.getPartDefinition("li").appendToFigure = true;
            }
            return true;
         }
         return false;
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_845.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      {
         return this.var_845.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_845.getAnimation(param1) as Animation;
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return this.var_1049.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_1049.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_1049.sortActions(param1);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         this.var_680[param1][param2] = this.var_397.getMandatorySetTypeIds(param1,param2);
         return this.var_680[param1][param2];
      }
      ...
      {
         return this.var_1049.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_845.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = this.var_466.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = this.var_466.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1822[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:Array = this.var_466.getActiveParts(param3.definition);
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc9_ = this.var_845.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
                  ...
                  if(_loc31_)
                  {
                     ...
                     for each(_loc32_ in _loc31_.parts)
                     {
                        if(_loc15_.indexOf(_loc32_.type) > -1)
                        {
                           ...
                           _loc12_ = this.var_466.getPartDefinition(_loc32_.type);
         ...
         for each(_loc11_ in _loc15_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc8_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc12_ = this.var_466.getPartDefinition(_loc11_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         return this.var_1583.getOffset(param1,param2,param3,param4,param5,param6);
      }
