package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_2120:int = 6710886;
      ...
      private var var_372:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1243 = [];
         this.var_1524 = [AvatarEditorFigureCategory.const_677,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_257,AvatarEditorFigureCategory.const_829,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_108];
         super();
         ...
         if(param4 == null)
         {
            param4 = this.var_1524;
         }
         for each(_loc6_ in param4)
         {
            this.var_1243.push(_loc6_);
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1524);
         }
         if(param1.length != this.var_1243.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1243.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2666 = this.canChangeOutfit();
            this.var_450.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_372 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_372.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_372.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1243.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_372.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_372.numSelectables)
               {
                  this.var_372.getSelectableAt(_loc6_).x = this.var_372.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_372.setSelected(this.var_372.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1524;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_45) && (this.var_1935 == AvatarEditorSideCategory.const_108 || this.var_2667))
         {
      ...
      {
         if(this.var_1935 == AvatarEditorSideCategory.const_108)
         {
            this.var_2667 = false;
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarEditorSideCategory.const_595:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_595);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_367 = param1;
         this.var_372.setSelected(this.var_372.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2668 = new Date().valueOf();
                  this.var_2666 = false;
                  this.var_450.start();
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2668 > 5000;
      }
   }
}
