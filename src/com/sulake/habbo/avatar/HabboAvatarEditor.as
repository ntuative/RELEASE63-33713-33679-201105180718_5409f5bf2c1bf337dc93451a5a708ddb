package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_1279:AvatarEditorHandler;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_197)
         {
            ...
            this.var_669["null"] = new FigureData(this);
            this.var_669["null"] = new FigureData(this);
            _loc2_ = this.var_669["null"];
            _loc3_ = this.var_669["null"];
            _loc2_.loadAvatarData(const_1550,FigureData.const_78);
            _loc3_.loadAvatarData(const_1549,FigureData.FEMALE);
            this.var_106 = new Map();
            this.var_548 = new Map();
            this.var_106.add(AvatarEditorFigureCategory.const_677,new BodyModel(this));
            this.var_106.add(AvatarEditorFigureCategory.const_52,new HeadModel(this));
            this.var_106.add(AvatarEditorFigureCategory.const_257,new TorsoModel(this));
            this.var_106.add(AvatarEditorFigureCategory.const_829,new LegsModel(this));
            ...
            this.var_548.add(AvatarEditorSideCategory.const_108,new WardrobeModel(this));
            this.var_548.add(AvatarEditorSideCategory.const_595,new ClubPromoModel(this));
            this.var_197 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_669[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_677);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_548.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         this.var_1024 = this.var_549.getFigureData(AvatarType.const_130);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1279 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_669[this.var_894];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1556 != null)
         {
            ...
            this.var_1556.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_2005;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1278 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1551)
                  {
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1623)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1278 >= _loc6_.clubLevel))
               {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1278 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_548.getValue(AvatarEditorSideCategory.const_108);
      }
