package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      private var var_2670:IStructureData;
      
      private var var_1938:XML;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            this.var_1938 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         this.var_2670.appendXML(this.var_1938);
