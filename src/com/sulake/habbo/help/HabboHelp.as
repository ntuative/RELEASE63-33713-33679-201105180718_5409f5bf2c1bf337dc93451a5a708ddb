package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_842:HotelMergeUI;
      
      private var var_1573:CallForHelpData;
      ...
      {
         this.var_1573 = new CallForHelpData();
         this.var_2816 = new UserRegistry();
         super(param1,param2,param3);
         this._assetLibrary = param3;
         this.var_1300 = new FaqIndex();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1301)
         {
            this.var_1301.release(new IIDHabboLocalizationManager());
            this.var_1301 = null;
         }
         if(this.var_251)
         {
      ...
      public function sendMessage(param1:IMessageComposer) : void
      {
         ...
         {
            this.var_251.getHabboMainConnection(null).send(param1);
         }
      }
      ...
      {
         this.var_1573.reportedUserId = param1;
         this.var_1573.reportedUserName = param2;
         this.var_67.showUI(HabboHelpViewEnum.const_394);
      }
      ...
      public function initHotelMergeUI() : void
      {
         if(!this.var_842)
         {
            this.var_842 = new HotelMergeUI(this);
         }
         this.var_842.startNameChange();
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_111)
         {
            this.var_111.showView(TutorialUI.const_337);
         }
      }
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._incomingMessages = new IncomingMessages(this,this.var_251);
      ...
      {
         this.var_1301 = IHabboLocalizationManager(param2);
