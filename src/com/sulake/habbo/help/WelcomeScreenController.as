package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      private var var_198:Point;
      
      private var var_2675:WelcomeNotification;
      
      public function WelcomeScreenController(param1:HabboHelp, param2:IHabboWindowManager)
      {
         this.var_198 = new Point(72,10);
         super();
         this.var_185 = param1;
      ...
      public function dispose() : void
      {
         if(this.var_185)
         {
            ...
            this.var_185.toolbar.events.removeEventListener(HabboToolbarEvent.const_50,this.onToolbarClicked);
            this.var_185 = null;
         }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         ...
         this.var_185.toolbar.events.addEventListener(HabboToolbarEvent.const_50,this.onToolbarClicked);
         ...
         this.var_198.y = this.var_185.toolbar.getIconVerticalLocation(param1.targetIconId) - this._window.height / 2;
         this._window.y = this.var_198.y;
      ...
      private function initializeWindow() : void
      {
         ...
         _loc4_.content.setParamFlag(WindowParam.const_340,false);
         _loc4_.height -= 20;
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_198);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_198,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_198.x;
            this._window.y = this.var_198.y;
            this.var_185.removeUpdateReceiver(this);
         }
      }
