package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_735)
         {
            this.var_735 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_735)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_736)
         {
            this.var_736 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_736)
            {
               return;
            }
