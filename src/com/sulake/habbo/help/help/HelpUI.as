package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1882:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201105180713));
         this.var_117 = new Map();
         this.var_117.add(HabboHelpViewEnum.const_1630,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_194,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_538,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_359,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_242,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_394,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_704,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_243,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_117.add(HabboHelpViewEnum.const_1101,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_117.add(HabboHelpViewEnum.const_1221,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_685,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_530.length == 0 || param1 != this.var_367)
            {
               this.var_530.push(this.var_367);
            }
         }
         this.var_367 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_243:
               ...
               break;
            case CallForHelpResultEnum.const_1195:
               this.showUI(HabboHelpViewEnum.const_1221);
               break;
            case CallForHelpResultEnum.const_1299:
               this.showUI(HabboHelpViewEnum.const_1101);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_117.getValue(HabboHelpViewEnum.const_194) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_549));
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2323;
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_530.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_367 == HabboHelpViewEnum.const_194)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_367 == HabboHelpViewEnum.const_194 || this.var_530.length == 0)
         {
            return;
         }
         if(this.var_366 == null)
