package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2248:FriendListLookAndFeel;
      
      private var var_411:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1664:OpenedToWebPopup;
      ...
      private var var_1663:AvatarSearchResults;
      ...
      {
         this.var_2248 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_106 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1663 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_581.stop();
            this.var_581.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_581 = null;
         }
         ...
         if(this.var_965)
         {
            this.var_965.release(new IIDAvatarRenderManager());
            this.var_965 = null;
         }
         if(this.var_928)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1664 = new OpenedToWebPopup(this);
         }
         this.var_1664.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_383);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_319,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_965.createAvatarImage(param1,AvatarScaleType.const_92,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_928 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_106.addCategory(new FriendCategory(FriendCategory.const_1317,this.getText("friendlist.friends")));
         ...
         this.var_411 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_581)
         {
            this.var_581 = new Timer(120000);
            this.var_581.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_581.start();
         }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_411.findTab(FriendListTab.const_100).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_411.findTab(FriendListTab.const_100);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1663.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_411.findTab(FriendListTab.const_100);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_715 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_715.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_715.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_45))
         {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_173) as IBitmapWrapperWindow;
