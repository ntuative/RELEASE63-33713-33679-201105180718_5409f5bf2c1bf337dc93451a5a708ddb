package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1994:int = "F".charCodeAt(0);
      
      public static const const_2151:int = "M".charCodeAt(0);
      ...
      private var var_1330:BitmapData;
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_894 = param1.gender;
         this.var_792 = param1.online;
         this.var_1665 = param1.followingAllowed && param1.online;
         this.var_587 = param1.figure;
         this.var_2010 = param1.motto;
         this.var_1881 = param1.lastAccess;
         this.var_1489 = param1.categoryId;
         this.var_1879 = param1.realName;
