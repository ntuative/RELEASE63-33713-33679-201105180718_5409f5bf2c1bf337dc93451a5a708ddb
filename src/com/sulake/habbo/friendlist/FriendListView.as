package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1430:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1941:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1941 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1430;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_893 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_253 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1941.prepare(this.var_893);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1169,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1216,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_940,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_749,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_940,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_749,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1527 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1527.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1944 == -1 ? 0 : int(this.var_17.height - this.var_1944);
         var _loc4_:int = this.var_1942 == -1 ? 0 : int(this.var_17.width - this.var_1942);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1309,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_940,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1169,false);
         ...
         this.var_1944 = this.var_17.height;
         this.var_1942 = this.var_17.width;
