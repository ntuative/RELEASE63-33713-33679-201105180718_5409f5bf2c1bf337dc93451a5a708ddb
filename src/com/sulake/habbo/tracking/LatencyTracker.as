package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1762 = int(this.var_178.getKey("latencytest.interval"));
         this.var_1759 = int(this.var_178.getKey("latencytest.report.index"));
         this.var_2403 = int(this.var_178.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1760 > this.var_1762)
         {
            this.testLatency();
         }
      }
      ...
      {
         this.var_1760 = getTimer();
         this.var_608.add(this.var_1441,this.var_1760);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1441));
         ++this.var_1441;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_608 == null || this.var_225 == null)
         {
            return;
         }
         ...
         if(this.var_225.length == this.var_1759 && this.var_1759 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1761) > this.var_2403 || this.var_1761 == 0)
            {
               this.var_1761 = _loc9_;
