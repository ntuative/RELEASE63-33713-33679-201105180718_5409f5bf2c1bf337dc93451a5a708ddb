package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_991:uint = 11;
      ...
      private var var_1099:IHabboWindowManager;
      ...
      private var var_248:PerformanceTracker = null;
      
      private var var_409:FramerateTracker = null;
      
      private var var_249:LatencyTracker = null;
      
      private var var_578:LagWarningLogger = null;
      
      private var var_410:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_248 = new PerformanceTracker();
         this.var_409 = new FramerateTracker();
         this.var_249 = new LatencyTracker();
         this.var_578 = new LagWarningLogger();
         this.var_410 = new ToolbarClickTracker(this);
         this.var_1372 = new Array(const_991);
         var _loc4_:int = 0;
         while(_loc4_ < const_991)
         {
            this.var_1372[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1615,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1883,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_865,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1257,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1099)
            {
               this.var_1099.release(new IIDHabboWindowManager());
               this.var_1099 = null;
            }
            if(this._adManager)
            {
            ...
            if(this.var_199)
            {
               if(!this.var_199.disposed)
               {
                  ...
                  Component(this.var_199).events.removeEventListener(HabboFriendListTrackingEvent.const_554,this.onFriendlistTrackingEvent);
               }
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_343,this.onRoomAction);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_178)
         {
            if(this.var_249 != null)
            {
               this.var_249.configuration = this.var_178;
            }
            if(this.var_248 != null)
            {
               this.var_248.configuration = this.var_178;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1809);
            if(this.var_178)
            {
               if(this.var_578 != null)
               {
                  this.var_578.configure(this.var_178);
               }
               if(this.var_409 != null)
               {
                  this.var_409.configure(this.var_178);
               }
               if(this.var_410 != null)
               {
                  this.var_410.configure(this.var_178);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_922,this.onConnectionEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_578 != null)
            {
               this.var_578.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1814);
         }
         else if(param1.type == HabboHotelViewEvent.const_564)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1843);
         }
         else if(param1.type == HabboHotelViewEvent.const_72)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1712);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1800);
               break;
            case HabboCommunicationEvent.const_922:
               this.trackLoginStep(HabboLoginTrackingStep.const_1782,String(this._communication.port));
               break;
      ...
      {
         this.var_1099 = IHabboWindowManager(param2);
         if(this.var_1099)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_178)
            {
               if(this.var_178.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1372)
                  {
                  ...
                  if(this.var_248 != null)
                  {
                     _loc4_["null"] = this.var_248.flashVersion;
                     _loc4_["null"] = this.var_248.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1223);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1223,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_199).events.addEventListener(HabboFriendListTrackingEvent.const_554,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_554:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2207)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1871);
            this.var_2207 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1257,String(_loc2_.guestRoomId));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_343,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this._adManager = param2 as IAdManager;
         this._adManager.events.addEventListener(AdEvent.const_505,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_348)
         {
            if(this.var_1649 < 1)
            {
               if(!this.var_292)
         ...
         else if(param1.type == RoomEngineEvent.const_343)
         {
            if(this.var_292)
            {
               this.var_292.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_409)
               {
                  ...
                  this.trackConversionPoint("Performance","fps",String(this.var_409.frameRate),_loc2_);
                  ++this.var_1649;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_410)
         {
            this.var_410.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_410)
         {
            this.var_410.track(param1.type);
         }
      }
      ...
      {
         this.var_578.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_486 > -1 && _loc2_ < this.var_486)
         {
            ++this.var_1650;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1650);
         }
         if(this.var_486 > -1 && _loc2_ - this.var_486 > 15000)
         {
            ++this.var_1651;
         ...
         if(this.var_248 != null)
         {
            this.var_248.update(param1,this.var_486);
         }
         if(this.var_249 != null)
         {
            this.var_249.update(param1,this.var_486);
         }
         if(this.var_409 != null)
         {
            this.var_409.trackUpdate(param1,this,this.var_486);
         }
         if(this.var_578 != null)
         {
            this.var_578.update(this.var_486);
         }
      }
   }
}
