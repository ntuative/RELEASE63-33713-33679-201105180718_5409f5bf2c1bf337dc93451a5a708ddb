package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable, IUpdateReceiver
   {
      ...
      private var var_638:QuestsList;
      ...
      private var var_961:CampaignCompleted;
      ...
      public function QuestController(param1:HabboQuestEngine)
      {
         ...
         this.var_638 = new QuestsList(this._questEngine);
         this.var_527 = new QuestDetails(this._questEngine);
         this._questCompleted = new QuestCompleted(this._questEngine);
         this.var_961 = new CampaignCompleted(this._questEngine);
      }
      
      public function onToolbarClick() : void
      {
         this.var_638.onToolbarClick();
      }
      
      public function onQuests(param1:Array, param2:Boolean) : void
      {
         this.var_638.onQuests(param1,param2);
      }
      ...
      {
         this.var_638.onRoomExit();
         this.var_365.onRoomExit();
         this.var_527.onRoomExit();
         this.var_961.onRoomExit();
      }
