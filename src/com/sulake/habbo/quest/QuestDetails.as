package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1338:int = 56;
      
      private static const const_636:int = 5;
      
      private static const const_1337:int = 5;
      
      private static const const_1339:int = 30;
      
      private static const const_990:Point = new Point(8,8);
      
      private static const const_1340:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER"];
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            _loc9_.x = const_990.x;
            _loc9_.y = const_990.y;
         ...
         _loc2_.height = _loc2_.textHeight + const_1337;
         var _loc4_:int = _loc2_.height - _loc3_ + (!!_loc2_.visible ? 0 : const_1339);
         _loc2_.visible = true;
         var _loc5_:IRegionWindow = IRegionWindow(this._window.findChildByName("catalog_link_region"));
         var _loc6_:* = const_1340.indexOf(param1.type) > -1;
         _loc5_.y = _loc2_.y + _loc2_.height + const_636;
         var _loc7_:int = 0;
         if(_loc6_ && !_loc5_.visible)
         {
            _loc7_ = const_636 + _loc5_.height;
         }
         if(!_loc6_ && _loc5_.visible)
         {
            _loc7_ = -const_636 - _loc5_.height;
         ...
         this._window.height = _loc9_.height + const_1338;
