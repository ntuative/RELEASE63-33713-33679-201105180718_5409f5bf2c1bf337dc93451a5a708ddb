package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private var var_1177:QuestController;
      
      private var var_936:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1177 = new QuestController(this);
         this.var_936 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1402);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_358.events.removeEventListener(BadgeImageReadyEvent.const_107,this.var_936.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_358.events.addEventListener(BadgeImageReadyEvent.const_107,this.var_936.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_50)
         {
            ...
            {
               this.var_1177.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_936.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1177.questTracker.isVisible();
      }
      ...
      public function setupAchievementCategoryImage(param1:IWindowContainer, param2:AchievementCategory) : void
      {
         ...
         var _loc4_:String = "achmain_" + param2.code + (param2.getProgress() > 0 ? "_active" : "_inactive");
         if(_loc3_.tags[0] == _loc4_)
         {
            Logger.log("No need to refresh category image...");
            return;
         }
         _loc3_.tags[0] = _loc4_;
         new PendingImage(this,_loc3_,_loc4_);
      }
      
      public function isQuestingEnabled() : Boolean
      {
         return this.var_178.getKey("questing.enabled","false") == "true";
      }
