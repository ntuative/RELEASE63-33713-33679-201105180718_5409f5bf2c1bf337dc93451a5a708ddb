package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_728 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_728.toggle();
         this.var_1722 = false;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_60.spacing = const_1368;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1369;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1367;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1366;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1722 && !this.var_1721)
            {
               this.var_1722 = false;
