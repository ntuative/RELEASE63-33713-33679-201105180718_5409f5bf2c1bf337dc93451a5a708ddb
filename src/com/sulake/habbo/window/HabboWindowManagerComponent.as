package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_932:IWindowRenderer;
      
      private var _skinContainer:ISkinContainer;
      
      private var var_259:Array;
      
      private var var_1457:IEventDispatcher;
      
      private var var_1176:Boolean = false;
      
      private var var_1799:ProfilerOutput;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_932 = new WindowRenderer(this._skinContainer);
         this._windowContextArray = new Array(const_447);
         ...
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_932,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_278 = this._windowContextArray[const_1401];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1799)
            {
               this.var_1799 = new ProfilerOutput(context,this,this.var_932);
            }
            this.var_1799.profiler = _loc3_;
            this.var_1456 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1456);
            this.var_1455 = new ProfilerAgentTask("Redraw","Window rasterizer");
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1457.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_447 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1457.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         this.var_1457.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1810,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1761,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1777,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1700,param2.name + ": " + param2.toString());
            }
         }
      }
