package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_1607:IButtonWindow;
      
      private var var_1606:IButtonWindow;
      
      private var var_2905:IButtonWindow;
      
      private var var_1608:IButtonWindow;
      
      private var var_1076:IDropMenuWindow;
      ...
      {
         this.var_1076.visible = false;
         this.var_2093.visible = true;
         this.var_2904.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_859.setText(param1.eventDescription);
         this.var_909.setText(this.getTagFromEvent(param1,1));
         this.var_911.setText(this.getTagFromEvent(param1,2));
         this.var_1607.visible = false;
         this.var_1606.visible = true;
         this.var_1608.visible = true;
         this.var_2095.visible = false;
         this.var_2094.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_1076.selection;
         return _loc1_ + 1;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_859.getText();
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_859.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_2093 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2904 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_2095 = ITextWindow(this.find("create_caption"));
            this.var_2094 = ITextWindow(this.find("edit_caption"));
            this.var_1607 = IButtonWindow(this.find("create_button"));
            this.var_1606 = IButtonWindow(this.find("edit_button"));
            this.var_2905 = IButtonWindow(this.find("cancel_button"));
            this.var_1608 = IButtonWindow(this.find("end_button"));
            this.var_1076 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1607,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1606,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1608,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2905,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_859 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
