package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1980:TextSearchInputs;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1980 == null)
         {
            ...
            this.var_1980 = new TextSearchInputs(this._navigator,false,_loc4_);
            this.initClearResults(_loc4_);
         }
         var _loc3_:IWindowContainer = param1.getChildByName("search_header") as IWindowContainer;
         if(this._navigator.data.guestRoomSearchArrived && this._navigator.data.guestRoomSearchResults.searchType == Tabs.const_238)
         {
            this.var_1980.searchStr.setText(this._navigator.data.guestRoomSearchResults.searchParam);
         }
      ...
      {
         this._navigator.mainViewCtrl.startSearch(Tabs.const_206,Tabs.const_238,"-1",MainViewCtrl.const_786);
      }
