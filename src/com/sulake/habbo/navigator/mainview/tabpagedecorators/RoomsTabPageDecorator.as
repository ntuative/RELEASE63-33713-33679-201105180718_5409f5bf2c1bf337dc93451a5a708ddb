package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_149:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_149 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            this.prepareRoomCategories();
            this.var_149.addEventListener(WindowEvent.const_48,this.onFilterSelected);
         }
         _loc3_.visible = true;
      }
      ...
      public function tabSelected() : void
      {
         if(this.var_149 != null)
         {
            this.var_149.removeEventListener(WindowEvent.const_48,this.onFilterSelected);
            this.var_149.selection = 0;
            this.var_149.addEventListener(WindowEvent.const_48,this.onFilterSelected);
         }
      }
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = this.var_149 == null ? 0 : int(this.var_149.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_221,Tabs.const_403);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_221,Tabs.const_914);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_221,Tabs.const_403,"" + _loc3_);
         }
         if(this.var_149)
         {
            this._navigator.trackNavigationDataPoint(this.var_149.enumerateSelection()[this.var_149.selection],"category.view");
         }
      }
      
      public function get filterCategory() : String
      {
         return !!this.var_149 ? this.var_149.enumerateSelection()[this.var_149.selection] : null;
      }
   }
}
