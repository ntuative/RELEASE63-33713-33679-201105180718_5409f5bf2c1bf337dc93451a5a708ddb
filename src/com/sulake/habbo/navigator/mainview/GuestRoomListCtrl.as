package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_572 = IScrollbarWindow(this.var_183.findChildByName("scroller"));
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_207,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1706,true);
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_544.visible && this.var_2734)
         {
            return;
         }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1545.tags[0];
            this.var_1545.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2733 - _loc2_.stageX);
         this.var_2733 = _loc2_.stageX;
         this.var_2734 = _loc3_ > 2;
      }
   }
}
