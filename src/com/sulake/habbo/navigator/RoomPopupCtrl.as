package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_122:GuestRoomData;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2706 = new RoomThumbnailRenderer(param1);
         this.var_1002 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_191,this.var_122);
         if(this.var_122.ownerName != "" && this.var_122.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_191,!!this.var_122.event ? this.getEventCtg(this.var_122.categoryId) : this.getRoomCtg(this.var_122.categoryId));
         this.refreshRoomDesc(this.var_191,this.var_122);
         this.refreshExtraCont();
         this.refreshInfo(this.var_191,"trading_allowed",this.var_122.allowTrading);
         this.refreshInfo(this.var_191,"doormode_doorbell",this.var_122.doorMode == 1);
         this.refreshInfo(this.var_191,"doormode_password",this.var_122.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_191,this.var_122.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1002.refreshTags(_loc1_,this.var_122.tags);
         this.refreshTextWithCaption("rating",_loc1_,"" + this.var_122.score);
         if(this.var_122.event)
         {
            this.refreshTextWithCaption("startedat",_loc1_,"" + this.var_122.eventCreationTime);
         }
         this.var_2706.refreshThumbnail(_loc1_,this.var_122.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_206,Tabs.const_238,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
