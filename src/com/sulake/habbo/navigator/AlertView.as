package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_689:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:AlertView = var_689[this.var_1093] as AlertView;
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         ...
         this.setupAlertWindow(this.var_289);
      ...
      {
         var _loc1_:IFrameWindow = this._navigator.getXmlWindow(this.var_1093,2) as IFrameWindow;
