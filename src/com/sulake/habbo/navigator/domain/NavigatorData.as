package com.sulake.habbo.navigator.domain
{
   ...
   public class NavigatorData
   {
      ...
      private var var_676:RoomEventData;
      ...
      private var var_1039:PublicRoomShortData;
      ...
      public function onRoomEnter(param1:RoomEntryInfoMessageParser) : void
      {
         ...
         {
            this.var_1039 = param1.publicSpace;
            this.var_676 = null;
         }
      }
      ...
      {
         var _loc2_:int = 0;
         this.var_2806 = param1.limit;
         this.var_1571 = param1.favouriteRoomIds.length;
         this._favouriteIds = new Dictionary();
      ...
      {
         return this.var_1571 >= this.var_2806;
      }
