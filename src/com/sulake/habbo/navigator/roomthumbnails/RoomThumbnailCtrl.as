package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2065:IButtonWindow;
      
      private var var_2064:IButtonWindow;
      
      private var var_2872:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_2063 = IButtonWindow(this.find("bg_tab"));
         this.var_2065 = IButtonWindow(this.find("top_tab"));
         this.var_2064 = IButtonWindow(this.find("obj_tab"));
         this.var_2872 = IWindowContainer(this.find("tile_grid"));
         this.var_2873 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_2063,this.onBgTabButton);
         Util.setProcDirectly(this.var_2065,this.onTopTabButton);
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_68.mode = ThumbnailEditorModel.const_62;
         this.reload();
      }
      ...
      private function onObjTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_68.mode = ThumbnailEditorModel.const_36;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_2063,this.var_68.mode != ThumbnailEditorModel.const_37);
         this.setEnabled(this.var_2065,this.var_68.mode != ThumbnailEditorModel.const_62);
         this.setEnabled(this.var_2064,this.var_68.mode != ThumbnailEditorModel.const_36);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2873;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_68.mode == ThumbnailEditorModel.const_37);
         this.refreshEditImg(_loc1_,"edit_top",this.var_68.mode == ThumbnailEditorModel.const_62);
         this.refreshEditImg(_loc1_,"edit_obj",this.var_68.mode == ThumbnailEditorModel.const_36,false);
         if(this.var_68.mode == ThumbnailEditorModel.const_36)
         {
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2872;
         _loc1_.visible = true;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_496,HabboWindowStyle.const_46,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_319,HabboWindowStyle.const_46,HabboWindowParam.const_64,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
