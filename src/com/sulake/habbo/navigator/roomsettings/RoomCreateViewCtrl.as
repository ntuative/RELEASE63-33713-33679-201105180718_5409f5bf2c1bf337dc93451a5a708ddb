package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1193:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_57,104,"a"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_57,94,"b"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_57,36,"c"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_57,84,"d"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_57,80,"e"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_57,80,"f"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_57,416,"i"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_57,320,"j"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_57,448,"k"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_57,352,"l"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_57,384,"m"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_57,372,"n"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1193.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1824 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1824 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_1192 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_183.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function onCreateButtonClick(param1:WindowEvent) : void
      {
         ...
         var _loc3_:String = "model_" + this.var_1193.name;
