package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1427:String = "%";
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_634 = this.getKey("url_prefix");
         if(this.var_634 != null && this.var_634.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_634 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. URL " + this.getKey("external.variables.txt") + "HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1879);
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         this.var_634 = this.getKey("url.prefix");
         if(this.var_634.length > 0)
         {
            externalAccessDomain = this.var_634.replace("http://","");
      ...
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_634);
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         ...
         if(this.var_1852.indexOf(param1) < 0 || param3)
         {
            this.var_959[param1] = param2;
         }
         if(param3)
         {
            this.var_1852.push(param1);
         }
      }
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1427);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1427,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
