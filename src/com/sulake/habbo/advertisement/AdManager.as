package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      public function AdManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(AdImageEvent.const_184,this.onLoadAdImage);
      }
      ...
      {
         this.var_251 = param2 as IHabboCommunicationManager;
         if(this.var_251 == null)
         {
            return;
         }
         this._connection = this.var_251.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2303 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2306 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2304 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1704 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1119 == 0)
         {
            this.var_1119 = getTimer();
            return false;
         }
         if(this.var_1704 > 0 && this.var_1702 >= this.var_1704)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1119;
         if(_loc1_ > this.var_2306)
         {
            ++this.var_1702;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1401 = _loc2_.imageUrl;
         this.var_2305 = _loc2_.clickUrl;
         this.var_1119 = getTimer();
         if(this.var_1401 != "")
         {
            _loc3_ = this.var_1401;
            ...
            {
               this.var_221 = new Timer(this.var_2304,1);
            ...
            this.var_221.start();
            _loc4_ = new URLRequest(this.var_1401);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_467,0,0,param1.bitmapData,this.var_2305));
            this.var_1119 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_503));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1402 = _loc2_.imageUrl;
         this.var_1703 = _loc2_.clickUrl;
         if(this.var_1402 != "" && this.var_1703 != "")
         {
            ...
            _loc4_ = new URLRequest(this.var_1402);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_505,0,0,_loc4_,_loc2_.assetName,this.var_1703,this.var_1120,this.var_1118));
         }
      }
      ...
      public function loadRoomAdImage(param1:int, param2:int, param3:String, param4:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdImageEvent(AdImageEvent.const_184,param3,param4,param1,param2));
         }
      }
      ...
      private function loadImageAsset(param1:AdImageEvent) : void
      {
         ...
         var _loc3_:Array = this.var_588.getValue(_loc2_);
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_588.add(_loc2_,_loc3_);
         }
         if(_loc3_.length > 0)
         {
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_588.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_759,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_588.remove(_loc2_.assetName);
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_976,_loc4_.roomId,0,null,_loc4_.imageUrl,_loc4_.clickUrl,null,null,_loc4_.objectId));
         }
      }
   }
}
