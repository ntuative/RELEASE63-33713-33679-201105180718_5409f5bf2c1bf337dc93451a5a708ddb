package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2930:BitmapData;
      
      private var var_1499:Boolean;
      
      private const const_1953:Number = 1;
      
      private const const_1954:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2624 = this._window.findChildByName("outline");
         this._roomEngine = param5;
         this.var_2930 = param6;
         this.var_2159 = param7;
         this._items = new Map();
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2158 == FurniModelCategory.const_39)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1403));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2160);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_694)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               this._window.blend = this.const_1953;
               _loc1_.blend = this.const_1953;
            }
         }
         this.var_1413.color = !!this.var_1499 ? uint(const_1448) : uint(const_1449);
         this.var_2624.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2159 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2930;
               _loc5_.visible = true;
            }
            else
            {
