package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1476:int = 100;
      
      private static const const_1475:int = 1000;
      ...
      private var var_1913:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_441 = [];
         this.var_442 = [];
         this.var_652 = new Timer(const_1476,1);
         this.var_652.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2638 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_652.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_652.stop();
               this.var_652 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_39)
            {
               ...
               {
                  this.var_1913 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1913;
            }
            else
            {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_803 == null)
         {
            this.var_803 = this._windowManager.buildFromXML(this.var_2638) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_803.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_803.clone() as IWindowContainer;
         ...
         if(param1 == InventoryCategory.const_67 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_42:
                  ...
                  break;
               case const_275:
                  this._controller.toggleInventoryPage(InventoryCategory.const_122);
            }
         }
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_434);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_651.add(const_39,new Array());
         this.var_651.add(const_42,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         else
         {
            ...
            _loc6_ = const_42;
            _loc5_ = this.var_442.indexOf(param1.ref) > -1;
         }
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_209)
                  {
                     _loc7_ = _loc9_;
                  }
      ...
      {
         return getTimer() < this.var_2637 + const_1475;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_320 || _loc3_.category == FurniCategory.const_315 || _loc3_.category == FurniCategory.const_309)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_651.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_694)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_442.indexOf(_loc2_) == -1)
            {
               this.var_442.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            ...
            case UnseenItemCategoryEnum.const_415:
               return this.var_442.length;
            default:
               return this.var_441.length + this.var_442.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_42:
               if(this.var_442 && this.var_442.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_415));
                  this.var_442 = [];
