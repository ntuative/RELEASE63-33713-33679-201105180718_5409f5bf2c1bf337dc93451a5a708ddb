package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_67,false);
      }
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_339);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         this.var_13.toggleInventorySubPage(InventorySubCategory.const_306);
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_209)
            {
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_122);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_434);
      ...
      {
         var _loc2_:* = null;
         if(this.var_13.isInventoryCategoryInit(InventoryCategory.const_434))
         {
      ...
      private function onUnseenItems(param1:UnseenItemsEvent) : void
      {
         ...
         this.var_13.furniModel.addUnseenFloorItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_406));
         this.var_13.furniModel.addUnseenWallItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_415));
