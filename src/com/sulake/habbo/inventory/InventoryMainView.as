package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private const const_1928:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this._controller.inventoryViewOpened(this.var_768);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_361 != null && this.var_361 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_361 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_768);
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_361);
         }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_361 == InventoryCategory.const_122)
            {
               this.toggleCategoryView(InventoryCategory.const_122);
            }
            else if(this.var_361 == InventoryCategory.const_67)
            {
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(!this.var_937)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc3_.x = _loc4_.width - _loc3_.width - const_1022;
               _loc3_.y = const_1022;
            }
            this.var_937 = _loc3_;
         }
         if(_loc1_ > 0)
         {
            ...
            this.var_937.findChildByName("count").caption = _loc1_.toString();
         }
         else
         {
