package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_122 && this._controller.isVisible)
         {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_1657 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_33,RoomObjectTypeEnum.const_189,_loc3_.figureString);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1657 && param1.type == RoomEngineObjectEvent.const_159)
         {
      ...
      public function addUnseenPets(param1:Array) : void
      {
         ...
         {
            if(this.var_490.indexOf(_loc2_) == -1)
            {
               this.var_490.push(_loc2_);
            }
         }
         this._view.update();
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         var _loc1_:IConnection = this._communication.getHabboMainConnection(null);
         if(this.var_490 && this.var_490.length > 0)
         {
      ...
      {
         return this.var_490.indexOf(param1) > -1;
      }
   }
}
