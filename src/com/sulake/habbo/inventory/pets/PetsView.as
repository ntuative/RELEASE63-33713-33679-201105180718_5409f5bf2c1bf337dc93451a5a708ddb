package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1956:int = 0;
      
      private const const_996:int = 1;
      
      private const const_1057:int = 2;
      
      private const const_1054:int = 3;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_200 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         var _loc2_:PetsGridItem = this.var_491.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_200.removeGridItem(_loc2_.window);
      ...
      {
         if(this.var_491 == null || this.var_491.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_491.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_491.getValue(param1.id) != null)
         {
            return;
         }
         var _loc2_:PetsGridItem = new PetsGridItem(this,param1,this._windowManager,this._assetLibrary,this._avatarRenderer,this.var_68.isUnseen(param1.id));
         if(_loc2_ != null)
         {
            this.var_200.addGridItem(_loc2_.window);
            this.var_491.add(param1.id,_loc2_);
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_48)
         {
            ...
            {
               case "tab_floor":
                  this.var_68.switchToFurnitureCategory(FurniModelCategory.const_39);
                  break;
               case "tab_wall":
                  this.var_68.switchToFurnitureCategory(FurniModelCategory.const_42);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function updateState() : void
      {
         ...
         if(!this.var_68.isListInitialized())
         {
            _loc2_ = this.const_996;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1057;
         }
         else
         {
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_68.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_406) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_68.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_415) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_pets");
         _loc1_.visible = this.var_68.getUnseenItemCount() > 0;
      }
   }
}
