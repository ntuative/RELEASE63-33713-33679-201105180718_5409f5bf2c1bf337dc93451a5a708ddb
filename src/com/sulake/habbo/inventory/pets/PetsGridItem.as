package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_43:
               this.var_1578.setSelectedGridItem(this);
               this.var_1579 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1579 = false;
                  this.var_1578.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1413)
         {
            return;
         }
         this.var_1413.color = !!this.var_2828 ? uint(const_1448) : uint(const_1449);
         this.var_2624.visible = param1;
      }
