package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2236:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            ...
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_575,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_52.getValue(InventoryCategory.const_67));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_52.getValue(InventorySubCategory.const_306));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_52.getValue(InventoryCategory.const_791));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_52.getValue(InventoryCategory.const_339));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_52.getValue(InventorySubCategory.const_1156));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_52.getValue(InventoryCategory.const_122));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_52.getValue(InventoryCategory.const_434) as MarketplaceModel;
      }
      ...
      {
         this.var_358 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_575,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_97:
               this.var_1146 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_575:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_358 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_52.add(InventoryCategory.const_434,_loc1_);
         ...
         this.var_52.add(InventoryCategory.const_67,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_358);
         this.var_52.add(InventoryCategory.const_339,_loc3_);
         ...
         this.var_52.add(InventoryCategory.const_791,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_358);
         ...
         this.var_52.add(InventorySubCategory.const_306,_loc6_);
         ...
         this.var_52.add(InventorySubCategory.const_1156,_loc7_);
         ...
         this.var_52.add(InventoryCategory.const_122,_loc8_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1053.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_1053.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1053.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1053.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2236);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_703));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2855)
         {
            this.var_2855 = _loc1_;
