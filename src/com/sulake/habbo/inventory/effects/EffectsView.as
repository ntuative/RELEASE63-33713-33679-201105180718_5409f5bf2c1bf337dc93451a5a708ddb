package com.sulake.habbo.inventory.effects
{
   ...
   public class EffectsView implements IInventoryView
   {
      ...
      private var var_832:ThumbListManager;
      
      private var var_831:ThumbListManager;
      ...
      public function EffectsView(param1:EffectsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IThumbListDataProvider, param6:IThumbListDataProvider)
      {
         ...
         this.var_832 = new ThumbListManager(this._assetLibrary,param5,"thumb_bg_png","thumb_bg_selected_png",this.getActiveThumbListImageWidth(),this.getActiveThumbListImageHeight());
         this.var_831 = new ThumbListManager(this._assetLibrary,param6,"thumb_bg_png","thumb_bg_selected_png",this.getActiveThumbListImageWidth(),this.getActiveThumbListImageHeight());
      ...
      public function updateListViews() : void
      {
         ...
         this.var_831.updateImageFromList();
         this.var_832.updateImageFromList();
         var _loc1_:IBitmapWrapperWindow = this._view.findChildByName("inactive_items_image") as IBitmapWrapperWindow;
         var _loc2_:BitmapData = this.var_831.getListImage();
         ...
         var _loc4_:BitmapData = this.var_832.getListImage();
      ...
      private function activeThumbListEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            _loc4_ = this.var_832.resolveIndexFromImageLocation(_loc3_);
      ...
      private function inactiveThumbListEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = new Point(WindowMouseEvent(param1).localX,WindowMouseEvent(param1).localY);
            _loc4_ = this.var_831.resolveIndexFromImageLocation(_loc3_);
