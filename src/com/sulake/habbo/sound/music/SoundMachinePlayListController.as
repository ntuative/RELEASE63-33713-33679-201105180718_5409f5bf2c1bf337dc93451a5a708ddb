package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_228 = param2;
         this.var_723 = [];
         this.var_723.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_723.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_723)
         {
         ...
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_897,this.onSoundMachinePlayEvent);
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_842,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_84)
            {
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_897,this.onSoundMachinePlayEvent);
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_842,this.onSoundMachineStopEvent);
               this.var_84 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_474);
