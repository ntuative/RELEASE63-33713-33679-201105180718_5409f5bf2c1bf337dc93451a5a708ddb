package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1552:int = HabboMusicPrioritiesEnum.const_132;
      ...
      private var var_550:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_723.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_723.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_723)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_709,this.onJukeboxInit);
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_250,this.onJukeboxDispose);
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_713,this.onSoundMachineInit);
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_728,this.onSoundMachineDispose);
         this.var_1280 = new Timer(1000);
         this.var_1280.start();
         this.var_1280.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_293)
         {
            this.var_322[_loc6_] = null;
            this.var_834[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_2008)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               for each(_loc1_ in this.var_723)
               {
            ...
            if(this.var_279)
            {
               ...
               {
                  _loc3_ = this.var_279.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_84)
            {
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_709,this.onJukeboxInit);
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_250,this.onJukeboxDispose);
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_713,this.onSoundMachineInit);
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_728,this.onSoundMachineDispose);
            }
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_279.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_293)
         {
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_279.length)
         {
            ...
            if(_loc3_.id != this.var_1557 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         while(_loc2_ < this.var_322.length)
         {
            if(this.var_322[_loc2_] != null)
            {
               ...
               _loc4_ = this.var_279.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_279.add(_loc6_.id,_loc10_);
               ...
               while(this.var_836.indexOf(_loc6_.id) != -1)
               {
                  this.var_836.splice(this.var_836.indexOf(_loc6_.id),1);
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_293)
         {
            return false;
         }
         ...
         if(_loc10_ != null)
         {
            ...
            _loc8_ = Number(_loc10_.method_3);
         ...
         _loc5_.method_3 = _loc8_;
         _loc5_.fadeOutSeconds = _loc9_;
         _loc5_.position = _loc6_;
         _loc5_.play(_loc7_);
         this._priorityPlaying = param1;
         this.var_2008 = this.getSongRequestCountAtPriority(param1);
         this.var_1557 = param2;
         if(this._priorityPlaying <= const_1552)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2779 != param1.id || _loc3_ > this.var_2780 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2779 = param1.id;
            this.var_2780 = _loc3_;
         }
      }
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_550 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_84,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_550 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
