package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_745,RoomWidgetStickieSendUpdateMessage.const_683,RoomWidgetStickieSendUpdateMessage.const_536];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_745:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     ...
                     _loc11_ = new RoomWidgetStickieDataUpdateEvent(RoomWidgetStickieDataUpdateEvent.const_975,_loc2_.id,_loc3_.getType(),_loc9_,_loc8_,_loc10_);
                     this._container.events.dispatchEvent(_loc11_);
                  }
               }
               break;
            case RoomWidgetStickieSendUpdateMessage.const_536:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_683:
