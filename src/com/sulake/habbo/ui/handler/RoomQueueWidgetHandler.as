package com.sulake.habbo.ui.handler
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_942);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1206);
               break;
            case RoomWidgetRoomQueueMessage.const_942:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1302);
               break;
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_495:
               ...
               {
                  case RoomSessionQueueEvent.const_1302:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_1206:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
