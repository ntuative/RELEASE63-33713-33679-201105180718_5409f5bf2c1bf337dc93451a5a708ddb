package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_228.events.addEventListener(NowPlayingEvent.const_101,this.onNowPlayingChanged);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_107,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_107,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_228 != null)
         {
            this.var_228.events.removeEventListener(NowPlayingEvent.const_101,this.onNowPlayingChanged);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_619);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_757);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_903);
         _loc1_.push(RoomWidgetFurniActionMessage.const_910);
         _loc1_.push(RoomWidgetFurniActionMessage.const_846);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1243);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_965);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_962);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1881);
         _loc1_.push(RoomWidgetPetCommandMessage.const_465);
         _loc1_.push(RoomWidgetPetCommandMessage.const_872);
         _loc1_.push(RoomWidgetUserActionMessage.const_483);
         _loc1_.push(RoomWidgetUserActionMessage.const_374);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_775);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_374 || param1.type == RoomWidgetUserActionMessage.const_483 || param1.type == RoomWidgetUserActionMessage.const_600)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_619:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_757:
            ...
            case RoomWidgetUserActionMessage.const_600:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_903:
            ...
            case RoomWidgetUserActionMessage.const_374:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_965:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_962:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_356);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_232) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_232);
               }
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1149);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1174);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_522)
                  {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_430) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_430.length);
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_189)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc12_.webID);
                  return null;
               }
               if(_loc12_.type == RoomObjectTypeEnum.const_161)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_519)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_615);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_117)
               {
                  _loc14_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_138)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_899);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_890;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_754;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1704);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_899);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_228 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_382,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
