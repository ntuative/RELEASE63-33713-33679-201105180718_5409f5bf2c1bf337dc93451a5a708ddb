package com.sulake.habbo.ui.handler
{
   ...
   public class PurseWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetPurseData.const_929);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetPurseData.const_929:
               ...
               this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_106,_loc2_.getActivityPointsForType(ActivityPointTypeEnum.PIXEL)));
               break;
            case RoomWidgetOpenCatalogMessage.const_438:
               ...
               if(this._container.catalog != null)
               {
                  ...
                  {
                     case RoomWidgetOpenCatalogMessage.const_1310:
                        this._container.catalog.openCatalogPage(CatalogPageName.const_1747);
                        break;
                     case RoomWidgetOpenCatalogMessage.const_1187:
