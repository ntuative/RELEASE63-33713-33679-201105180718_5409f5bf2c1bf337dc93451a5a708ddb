package com.sulake.habbo.ui.handler
{
   ...
   public class SpamWallPostItWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_2051:IMessageEvent;
      ...
      {
         this.var_2051 = new RequestSpamWallPostItMessageEvent(this.onSpamWallPostItRequest);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_2051);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this._disposed = true;
            this._connection.removeMessageEvent(this.var_2051);
      ...
      private function onSpamWallPostItRequest(param1:RequestSpamWallPostItMessageEvent) : void
      {
         ...
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetSpamWallPostItEditEvent(RoomWidgetSpamWallPostItEditEvent.const_607,_loc3_,_loc4_,_loc5_));
            }
         }
      }
      ...
      {
         return [RoomWidgetSpamWallPostItEditEvent.const_607,RoomWidgetSpamWallPostItFinishEditingMessage.const_695];
      }
