package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_2017:Map = null;
      
      private var var_1297:Array;
      
      private var _connection:IConnection = null;
      
      private var var_1298:Number = 0.0;
      
      private var var_840:Point = null;
      
      private var var_553:Vector3d;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_465 != null)
         {
            ...
            {
               _loc2_ = this.var_465.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1297)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_893,RoomWidgetChatSelectAvatarMessage.const_834];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_893:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_45) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1241))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_45) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1241))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_834:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_189)
                           {
                              _loc13_ = this.var_323.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_465.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_675.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_189:
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_675.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    ...
                                    {
                                       this.var_465.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1298 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1298);
            }
            if(this.var_840 == null)
            {
               ...
               this.var_553.y = 0;
               this.var_553.z = 0;
               this.var_840 = _loc4_.getScreenPoint(this.var_553);
               this.var_1298 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_553.x = 0;
            this.var_553.y = 0;
            this.var_553.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_553);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_840.x || _loc8_.y != this.var_840.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_840,_loc5_));
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_465)
         {
            _loc2_ = this.var_465.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1297.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_675.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_2017.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_2017.remove(param1);
         if(_loc3_ != null)
         {
