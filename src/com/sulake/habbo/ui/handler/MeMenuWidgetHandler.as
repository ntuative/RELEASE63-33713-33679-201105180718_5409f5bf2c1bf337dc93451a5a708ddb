   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_301,this.onFigureUpdate);
            }
            if(this.var_13 && !this.var_13.disposed && this.var_13.events)
            {
               this.var_13.events.removeEventListener(HabboInventoryEffectsEvent.const_703,this.onAvatarEffectsChanged);
               this.var_13.events.removeEventListener(HabboInventoryHabboClubEvent.const_725,this.onHabboClubSubscriptionChanged);
            }
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_301,this.onFigureUpdate);
         }
         this.var_13 = this._container.inventory;
         if(this.var_13 != null)
         {
            this.var_13.events.addEventListener(HabboInventoryEffectsEvent.const_703,this.onAvatarEffectsChanged);
            this.var_13.events.addEventListener(HabboInventoryHabboClubEvent.const_725,this.onHabboClubSubscriptionChanged);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1419)
            {
               ...
               this.var_1419 = _loc3_;
               this.var_1735 = _loc1_;
               this.var_1736 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1735;
               _loc2_ = this.var_1736;
            }
         }
         if(this._toolbar != null)
         {
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_446)
               {
                  ...
                  if(_loc2_.height > const_446 - const_1009)
                  {
                     _loc8_.offset(0,_loc2_.height - const_446 + const_1009);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_721);
         _loc1_.push(RoomWidgetDanceMessage.const_901);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_906);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_979);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_768);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_952);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_913);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_438);
         _loc1_.push(RoomWidgetStopEffectMessage.const_723);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1773);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1114);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_426);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1844);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1137);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_812);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_844);
         _loc1_.push(RoomWidgetMeMenuMessage.const_746);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_813);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1660);
         ...
         _loc1_.push(RoomWidgetClothingChangeMessage.const_401);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_844:
               ...
               break;
            case RoomWidgetWaveMessage.const_721:
            ...
            case RoomWidgetDanceMessage.const_901:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_906:
               if(this.var_13 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_979:
               if(this.var_13 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_768:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_438:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1252)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_212,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_913:
               ...
               if(this.var_13 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1244:
                        this._catalog.openCatalogPage(CatalogPageName.const_1905,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1168:
                        this.var_13.toggleInventoryPage(InventoryCategory.const_339);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1745:
                        this.var_13.toggleInventoryPage(InventoryCategory.const_67);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1744:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_952:
            case RoomWidgetStopEffectMessage.const_723:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1114:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_812:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_746:
               ...
               break;
            case RoomWidgetAvatarEditorMessage.const_426:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_813:
            ...
            case RoomWidgetAvatarEditorMessage.const_822:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_629));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_401:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_978));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_937));
      }
