package com.sulake.habbo.ui.handler
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetLetUserInMessage.const_862];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_862:
      ...
      {
         return [RoomSessionDoorbellEvent.const_115,RoomSessionDoorbellEvent.const_135,RoomSessionDoorbellEvent.const_61];
      }
