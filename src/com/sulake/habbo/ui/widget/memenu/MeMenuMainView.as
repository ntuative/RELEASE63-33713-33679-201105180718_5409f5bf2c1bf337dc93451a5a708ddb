      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1272);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
            ...
            case "badges":
               ...
               break;
            case "clothes":
               this._widget.changeView(MeMenuWidget.const_333);
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1252));
               this._widget.hide();
               break;
            case "settings":
