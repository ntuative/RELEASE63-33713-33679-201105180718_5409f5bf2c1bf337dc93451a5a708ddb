package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1069:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_930 = param1.volume;
         if(this.var_1069 != null)
         {
            this.var_1069.setValue(this.var_930);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1073 = (_loc5_.content as BitmapData).clone();
         }
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1072 = (_loc5_.content as BitmapData).clone();
         }
         ...
         this.var_1069 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_813));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_930 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1071);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1073);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1072);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1070);
         }
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "sounds_on":
               ...
               break;
            case "back_btn":
               this._widget.changeView(MeMenuWidget.const_732);
               break;
            default:
