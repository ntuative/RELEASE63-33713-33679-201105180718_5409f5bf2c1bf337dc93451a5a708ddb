package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      {
         super();
         this.var_207 = new Timer(this.const_2209);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_182.isActive)
         {
            ...
            this.var_935.width = _loc2_ * this.var_294;
         }
         else
         {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_766 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_766 == null)
            {
               return;
            }
         ...
         if(!this.var_182.isActive)
         {
            this.var_766.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_766.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_766.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(this.var_935 != null)
         {
            this.var_294 = this.var_935.width;
            this.var_207.start();
            this.onUpdate();
         }
