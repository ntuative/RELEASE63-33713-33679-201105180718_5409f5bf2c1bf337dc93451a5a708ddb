package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuClothesView implements IMeMenuView
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_822));
         }
         this._widget = null;
         if(this._window)
         {
            this._window.removeEventListener(WindowEvent.const_124,this.onViewChange);
            this._window.removeEventListener(WindowEvent.const_302,this.onViewChange);
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this._window.addEventListener(WindowEvent.const_302,this.onViewChange);
         this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_426,this._window));
      }
