package com.sulake.habbo.ui.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      private const const_1923:int = 3;
      
      private const const_2194:uint = 4.291993382E9;
      
      private const const_2195:uint = 4.29080704E9;
      
      private const const_2196:uint = 4.285767869E9;
      
      private const const_2197:uint = 4.28366404E9;
      ...
      public function PurseWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         if(_loc5_)
         {
            ...
            this._view.x = _loc6_.width - this._view.width - this.const_1923;
            this._view.y = this.const_1923;
      ...
      {
         this.var_1671 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("credits").caption = this.var_1671.toString();
            this._view.findChildByName("credits_shadow").caption = this.var_1671.toString();
         }
      }
      ...
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         ...
         if(this._view)
         {
            this._view.findChildByName("pixels").caption = this.var_1672.toString();
            this._view.findChildByName("pixels_shadow").caption = this.var_1672.toString();
         }
      }
      
      private function onCreditsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1187));
      }
      
      private function onPixelsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1310));
      }
      
      private function onOrangeMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2195;
      }
      
      private function onOrangeMouseOut(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2194;
      }
      
      private function onBlueMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2197;
      }
      
      private function onBlueMouseOut(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2196;
      }
   }
}
