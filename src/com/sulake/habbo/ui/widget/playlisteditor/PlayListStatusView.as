package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_789:String = "PLSV_ADD_SONGS";
      
      public static const const_1210:String = "PLSV_START_PLAYBACK";
      ...
      {
         if(this.var_44 != const_597)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_438[this.var_44];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_438[const_789];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_438.add(const_597,_loc1_);
