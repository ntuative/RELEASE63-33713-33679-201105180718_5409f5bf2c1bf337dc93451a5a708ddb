   ...
   public class MusicInventoryGridView
   {
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_653.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_104.playButtonState = MusicInventoryGridItem.const_1167;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_104 != null)
         {
            this.var_104.playButtonState = MusicInventoryGridItem.const_606;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc3_:* = param1.type == WindowMouseEvent.const_150;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_104.playButtonState == MusicInventoryGridItem.const_606)
               {
                  this.var_104.playButtonState = MusicInventoryGridItem.const_1301;
            ...
            {
               _loc4_ = this.var_653.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
