package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_953:String = "MISV_BUY_MORE";
      ...
      {
         this.blitBackgroundImage(const_953,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_438.add(const_946,_loc1_);
            this.var_1675 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1674 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_531));
         ...
         if(_loc1_ != null)
         {
            this.var_438.add(const_953,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_570));
         }
      }
