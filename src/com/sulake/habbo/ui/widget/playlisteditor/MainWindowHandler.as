package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MainWindowHandler
   {
      ...
      private static const const_1459:int = 6;
      
      private static const const_1460:int = 9;
      ...
      private var var_797:PlayListEditorItemListView;
      ...
      private var var_1909:IScrollbarWindow;
      ...
      public function MainWindowHandler(param1:PlayListEditorWidget, param2:IHabboMusicController)
      {
         ...
         this._widget = param1;
         this.var_228 = param2;
         var _loc3_:Array = [PlayListEditorWidgetAssetsEnum.const_885,PlayListEditorWidgetAssetsEnum.const_896,PlayListEditorWidgetAssetsEnum.const_531,PlayListEditorWidgetAssetsEnum.const_570,PlayListEditorWidgetAssetsEnum.const_919];
         ...
         this.var_797 = new PlayListEditorItemListView(param1,this.getPlayListEditorItemList());
      ...
      public function destroy() : void
      {
         if(this.var_228)
         {
            this.var_228.stop(HabboMusicPrioritiesEnum.const_429);
            this.var_228 = null;
         }
         if(this.var_535)
         {
      ...
      {
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_885)
         {
            this.assignWindowBitmapByAsset(this.var_972,"music_inventory_splash_image",PlayListEditorWidgetAssetsEnum.const_885);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_896)
         {
            this.assignWindowBitmapByAsset(this.var_973,"playlist_editor_splash_image",PlayListEditorWidgetAssetsEnum.const_896);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_531)
         {
            this.var_231.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_531));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_570)
         {
            this.var_231.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_570));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_919)
         {
            this.var_312.addSongsBackgroundImage = this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_919);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1908 = this.var_972.getChildByName("music_inventory_scrollbar") as IScrollbarWindow;
         this.var_1909 = this.var_973.getChildByName("playlist_scrollbar") as IScrollbarWindow;
         if(this.var_1908 == null)
         {
            throw new Error("Window content area is missing \'music_inventory_scrollbar\' window element");
         }
         if(this.var_1909 == null)
         {
      ...
      private function selectPlayListStatusViewByFurniPlayListState() : void
      {
         ...
         if(_loc1_.isPlaying)
         {
            this.var_312.selectView(PlayListStatusView.const_597);
         }
         else if(_loc1_.length > 0)
         {
            this.var_312.selectView(PlayListStatusView.const_1210);
         }
         else
         {
            this.var_312.selectView(PlayListStatusView.const_789);
         }
      }
      ...
      private function selectMusicStatusViewByMusicState() : void
      {
         ...
         {
            this.var_231.show();
            this.var_231.selectView(MusicInventoryStatusView.const_946);
         }
         else if(this.var_228.getSongDiskInventorySize() <= const_1459)
         {
            this.var_231.show();
            this.var_231.selectView(MusicInventoryStatusView.const_953);
         }
         else
         {
            this.var_231.hide();
      ...
      private function updatePlaylistEditorView() : void
      {
         ...
         this.var_797.refresh(_loc2_,_loc3_);
      }
      ...
      public function onPlayListUpdated() : void
      {
         ...
         this.var_1909.visible = _loc1_.length > const_1461;
      }
      ...
      public function onSongDiskInventoryReceived() : void
      {
         ...
         this.var_1908.visible = this.var_535.itemCount > const_1460;
      }
      ...
      public function onNowPlayingChanged(param1:RoomWidgetPlayListEditorNowPlayingEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPlayListEditorNowPlayingEvent.const_101:
               this.selectPlayListStatusViewByFurniPlayListState();
               this.var_797.setItemIndexPlaying(param1.position);
               if(param1.id != -1)
               {
      ...
      {
         return this.var_228.getSongIdPlayingAtPriority(HabboMusicPrioritiesEnum.const_429) != -1;
      }
   }
}
