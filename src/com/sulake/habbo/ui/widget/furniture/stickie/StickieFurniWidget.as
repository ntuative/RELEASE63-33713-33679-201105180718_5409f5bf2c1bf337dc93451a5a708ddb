package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1390:int = 14;
      
      private static const const_1388:int = 500;
      
      private static const const_1389:Number = 100;
      
      private static const const_1387:Number = 100;
       
      
      private var _window:IWindowContainer;
      
      protected var var_219:int = -1;
      ...
      protected var var_2144:String = "stickieui_container";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetStickieDataUpdateEvent.const_975,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetStickieDataUpdateEvent.const_975,this.onObjectUpdate);
      }
      ...
      protected function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         this.var_1345 = param1.objectType;
      ...
      protected function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow(this.var_2144,"",HabboWindowType.const_77,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1389,const_1387,2,2),null,0) as IWindowContainer;
         ...
         this.setColorButtons(this._controller && this.var_1345 == "post_it");
      }
      ...
      protected function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_536,this.var_219,this._text,this.var_334);
      ...
      protected function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_536,this.var_219,this._text,this.var_334);
      ...
      protected function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_683,this.var_219);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1388;
         if(_loc2_.numLines < const_1390)
         {
            return;
         }
