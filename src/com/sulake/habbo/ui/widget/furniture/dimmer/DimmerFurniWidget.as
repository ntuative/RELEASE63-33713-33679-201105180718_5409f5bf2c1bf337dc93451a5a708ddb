package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1540:Array = new Array(7665141,21495,15161822,15353138,15923281,8581961,0);
      
      private static const const_1541:Array = new Array(int(76.5),int(76.5));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_969,this.onPresets);
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_675,this.onHide);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_969,this.onPresets);
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_675,this.onHide);
      ...
      private function onPresets(param1:RoomWidgetDimmerUpdateEvent) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         this.var_1276 = param1.selectedPresetId - 1;
      ...
      public function storeCurrentSetting(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.var_1276 + 1;
         ...
         var _loc6_:DimmerFurniWidgetPresetItem = this._presets[this.var_1276] as DimmerFurniWidgetPresetItem;
