package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_2084:XML;
      
      private var var_693:BitmapData;
      
      private var var_1329:BitmapData;
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= this.var_562.numGridItems)
         {
            return;
         }
         this.select(this.var_562.getGridItemAt(param1) as IWindowContainer);
      }
      
      private function populate(param1:IHabboWindowManager) : void
      {
         if(this._view == null || this.var_562 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         this.var_562.destroyGridItems();
         this.var_217 = null;
         for each(_loc2_ in this.colors)
         {
            _loc3_ = param1.buildFromXML(this.var_2084) as IWindowContainer;
            ...
            this.var_562.addGridItem(_loc3_);
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1329.width,this.var_1329.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_1068.width,this.var_1068.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_1068,this.var_1068.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = this.var_562.getGridItemIndex(param1.target as IWindow);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_2084 = XML(_loc2_.content);
         ...
         this.var_1329 = BitmapData(_loc3_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_selected"));
         this.var_1068 = BitmapData(_loc3_.content);
      }
