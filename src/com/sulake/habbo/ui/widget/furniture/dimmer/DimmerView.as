package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_454:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_77,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1389,const_1387,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            this.var_454 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1558 = _loc2_.light;
         if(this.var_454 != null)
         {
            this.var_454.setValue(this.var_1558);
         }
         this.var_499 = this.colors.indexOf(_loc2_.color);
         if(this.var_671 != null)
         {
            this.var_671.setSelectedColorIndex(this.var_499);
         }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         return this.var_275.selector.method_2(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1559 = XML(_loc1_.content);
         return this.var_1559;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_454 != null)
         {
            this.var_454.min = this._widget.minLights[param1 - 1];
         }
      }
