package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_1014:String = "welcome_gift_email_verified";
      
      private const const_1386:String = "welcome_gift_email_change";
      
      private const const_2207:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1163)
         {
            this.setViewState(this.const_1014);
         }
         else
         {
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_647:
               ...
               this._view.findChildByName("edit_text").visible = this.var_926;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_926);
               break;
            ...
            case this.const_1386:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_926);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1444;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1386);
      }
      ...
      {
         this.setViewState(!!this.var_1163 ? this.const_1014 : this.const_647);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1445 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1445));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_591,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_809,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_591,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_809,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_591:
               this.var_1444 = param1.email;
               this.var_1163 = param1.isVerified;
               this.var_926 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1444 = this.var_1445;
            this.setViewState(this.const_647);
         }
         else
         {
            if(param1.result == this.const_2207)
            {
               this.var_926 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1445);
