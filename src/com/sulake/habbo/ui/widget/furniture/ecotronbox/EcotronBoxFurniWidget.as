package com.sulake.habbo.ui.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      private function showInterface() : void
      {
         ...
         this._window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_77,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1389,const_1387,2,2),null,0) as IWindowContainer;
      ...
      {
         var _loc1_:* = null;
         if(this.var_383 || this.var_219 == -1 || !this._controller)
         {
            return;
         }
         this.var_383 = true;
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_947,this.var_219);
