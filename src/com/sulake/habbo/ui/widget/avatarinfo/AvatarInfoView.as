package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoView
   {
      ...
      private static const const_1444:int = 25;
      ...
      protected var var_1620:int;
      
      protected var var_2155:Boolean;
      
      protected var var_2223:int;
      
      protected var var_1353:Boolean;
      
      protected var var_2156:FixedSizeStack;
      
      protected var var_2154:int = -1000000;
      
      public function AvatarInfoView(param1:AvatarInfoWidget)
      {
         this.var_2156 = new FixedSizeStack(const_1444);
         super();
         this._widget = param1;
      }
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_1620 = param5;
         param1.var_2223 = param4;
         param1.var_2155 = param6;
         param1.updateWindow();
      }
      ...
      public function update(param1:Rectangle, param2:Point, param3:Number) : void
      {
         ...
         if(!this.var_1353)
         {
            ...
            if(this.var_1620 == RoomObjectTypeEnum.const_161 || this.var_1620 == RoomObjectTypeEnum.const_519)
            {
            ...
            this.var_2156.addValue(_loc5_);
            _loc6_ = this.var_2156.getMax();
            if(_loc6_ < this.var_2154 - const_1045)
            {
               _loc6_ = this.var_2154 - const_1045;
            }
