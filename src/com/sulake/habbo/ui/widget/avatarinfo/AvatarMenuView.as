package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1332:uint = 0;
      
      protected static const const_361:uint = 1;
      
      protected static const const_984:uint = 2;
      
      protected static var var_1362:uint = const_361;
      
      private static const const_1553:uint = 4281149991;
      
      private static const const_1555:uint = 4283715916;
      
      private static const const_1557:uint = 16777215;
      
      private static const const_1558:uint = 9552639;
      
      private static const const_1554:uint = 16744755;
      
      private static const const_1556:uint = 16756591;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1361)
         {
            ...
            {
               this.var_337 = const_984;
            }
            else
            {
               this.var_337 = var_1362;
            }
         }
         if(this.var_337 == const_1332)
         {
         ...
         if(this.var_337 == const_1332 || this.var_337 == const_361)
         {
            ...
            else
            {
               ...
               this.var_337 = const_361;
            }
         }
         if(this.var_337 == const_361)
         {
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == "button")
            {
               param2.color = const_1555;
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               if(param2.tags.indexOf("actions") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1558;
               }
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1554;
               }
            }
         }
         if(_loc3_)
