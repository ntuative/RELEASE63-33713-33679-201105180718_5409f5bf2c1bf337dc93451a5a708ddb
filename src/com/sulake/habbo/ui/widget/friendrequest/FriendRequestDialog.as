package com.sulake.habbo.ui.widget.friendrequest
{
   ...
   public class FriendRequestDialog
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window.addEventListener(WindowEvent.const_528,this.onDeactivated);
      ...
      public function set targetRect(param1:Rectangle) : void
      {
         ...
         if(!param1)
         {
            this._widget.ignoreRequest(this.var_1123);
            return;
         }
         if(this.var_1353 || this.var_1707)
         {
            return;
         }
      ...
      private function onAccept(param1:WindowMouseEvent) : void
      {
         if(this._widget != null)
         {
            this._widget.acceptRequest(this.var_1123);
         }
      }
      ...
      private function onDecline(param1:WindowMouseEvent) : void
      {
         if(this._widget != null)
         {
            this._widget.declineRequest(this.var_1123);
         }
      }
   }
}
