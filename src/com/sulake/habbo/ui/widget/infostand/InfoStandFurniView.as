package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_242 = this.var_46.findChildByTag("catalog");
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_948 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_522 && param1.isRoomOwner)
         {
         ...
         this.showButton("HabboCatalogCom_thumb_bg",_loc6_);
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1113.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_53.addListItem(this.var_242);
            }
            this.var_242.visible = param1;
         }
         else
         {
            this.var_53.removeListItem(this.var_242);
         }
      }
   }
}
