package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private static const const_1430:Point = new Point(100,30);
      ...
      private const const_2224:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_363 = new Timer(this.const_2224);
         this.var_363.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1197.getValue(this.var_519) as CommandConfiguration;
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_872,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_40.setParamFlag(WindowParam.const_99,true);
         ...
         this.var_40.position = const_1430;
      }
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_374,this.var_519));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_465,this.var_519,this.var_1834 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_465,this.var_519,this.var_1834 + " " + _loc5_);
