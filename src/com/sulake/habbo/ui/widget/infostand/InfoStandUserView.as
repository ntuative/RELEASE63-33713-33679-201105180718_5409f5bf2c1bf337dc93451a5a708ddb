package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_139:IBorderWindow;
      
      private var var_2481:int;
      
      private var var_2482:Boolean = true;
      
      private const const_1019:int = 5;
      
      private const const_1934:int = 7829367;
      
      private const const_1935:int = 16777215;
      
      private const const_2211:int = 2000;
      
      private const const_2210:int = 50;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1002 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2482 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_139.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_139.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_139.x = _loc5_.left - this.var_139.width;
         this.var_139.y = _loc5_.top + (_loc5_.height - this.var_139.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_139.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_139.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_139.x = _loc7_.left - this.var_139.width;
         this.var_139.y = _loc7_.top + (_loc7_.height - this.var_139.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_139 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_139 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1019;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1934;
            }
            else
            {
               _loc3_.textColor = this.const_1935;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_1019,this.const_2210);
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_331,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_331,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1002.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_890:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_754:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2481 > this.const_2211 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2481 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1934;
         }
      }
