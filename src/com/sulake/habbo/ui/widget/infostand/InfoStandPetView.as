package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1526:int = 152;
      
      private static const const_1525:int = 16;
      
      private static const const_666:int = 4;
      
      private static const const_1535:uint = 14342874;
      
      private static const const_1531:uint = 3815994;
      
      private static const const_1528:uint = 2085362;
      
      private static const const_1538:uint = 39616;
      
      private static const const_1529:uint = 10513106;
      
      private static const const_1532:uint = 8734654;
      
      private static const const_1536:uint = 9094430;
      
      private static const const_1534:uint = 6200576;
      
      private static const const_1533:String = "happiness";
      
      private static const const_1530:String = "experience";
      
      private static const const_1527:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_46 == null || this.var_100 == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1533,param1.nutrition,param1.nutritionMax,const_1538,const_1528);
         this.updateStateElement(const_1530,param1.experience,param1.experienceMax,const_1532,const_1529);
         this.updateStateElement(const_1527,param1.energy,param1.energyMax,const_1534,const_1536);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1526,const_1525,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1535);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1531);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_666,_loc7_.width - 2,_loc7_.height - 2 - const_666);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_666);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_519) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_214 && this.var_214.getPetId() == this.var_519)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1684,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_372,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         this.var_100.height = _loc4_ + const_1066;
         this.updateWindow();
      }
   }
}
