package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2235:int = 5;
      ...
      private var var_1304:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1305 = 0;
         this.var_1304 = param2.rectangle.clone();
         this.var_1304.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1304.width)
         {
            return false;
         }
         if(this.var_1305 + param1.height > this.var_1304.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1304.width)
         {
            this._offsetX = 0;
            this.var_1305 += param1.height + this.const_2234;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1305);
         this._offsetX += param1.width + this.const_2235;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1576 != null && this.var_1576.indexOf(param1) != -1)
         {
