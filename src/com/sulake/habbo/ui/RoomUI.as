package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends ComponentContext implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1108:IRoomWidgetFactory;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_891.release(new IIDHabboModeration());
            this.var_891 = null;
         }
         ...
         if(this.var_1109)
         {
            this.var_1109.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1109 = null;
         }
         this.var_1686 = null;
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this._adManager.events.addEventListener(AdEvent.const_503,this.adEventHandler);
            this._adManager.events.addEventListener(AdEvent.const_467,this.adEventHandler);
            this._adManager.events.addEventListener(AdEvent.const_505,this.adEventHandler);
         }
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_891 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_891);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_16)
         {
            this.var_16.events.addEventListener(RoomSessionEvent.const_289,this.roomSessionStateEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionChatEvent.const_579,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionUserBadgesEvent.const_162,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDoorbellEvent.const_115,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionDoorbellEvent.const_135,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_612,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_530,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_561,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_510,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_811,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1234,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1273,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_803,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_733,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_692,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionQueueEvent.const_495,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionDimmerPresetsEvent.const_627,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionFriendRequestEvent.const_134,this.roomSessionEventHandler);
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_85:
               this._toolbar.setToolbarState(HabboToolbarEnum.const_900);
               break;
            case RoomSessionEvent.const_97:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.setToolbarState(HabboToolbarEnum.const_769);
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_276:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_811:
      ...
      {
         this.var_1109 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_343,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_815,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_888,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineSoundMachineEvent.const_250,this.roomObjectEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_678)
         {
            if(this.var_16 != null)
            {
               this.var_16.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_560 || param1.type == RoomEngineEvent.const_598)
         {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_348:
               ...
               if(this._config.getKey("purse.widget.enabled","0") == "1")
               {
                  ...
                  _loc3_.initializeWidget(RoomWidgetEnum.const_397);
               }
               if(!_loc5_)
               {
               ...
               if(this.var_1393 != RoomDesktop.const_588)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_330,this.var_1393);
               }
               if(this._adManager != null)
               {
                  this._adManager.showRoomAd();
               }
               _loc3_.createWidget(RoomWidgetEnum.const_566);
               _loc3_.createWidget(RoomWidgetEnum.const_552);
               break;
            case RoomEngineEvent.const_343:
               this.disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_815:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1108;
         _loc3_.sessionDataManager = this.var_358;
         ...
         _loc3_.moderation = this.var_891;
         _loc3_.config = this._config;
         _loc3_.soundManager = this._soundManager;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1109;
         ...
         _loc3_.createWidget(RoomWidgetEnum.const_876);
         _loc3_.init();
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_330);
            if(_loc3_ != RoomDesktop.const_588)
            {
               this.var_1393 = _loc3_;
            }
            _loc2_.dispose();
         }
      }
