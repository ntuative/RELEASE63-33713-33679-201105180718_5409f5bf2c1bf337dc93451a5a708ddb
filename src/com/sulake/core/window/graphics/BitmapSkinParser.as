   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_333 = SkinLayoutEntity.const_464;
                  break;
               case "move":
                  _loc5_.var_333 = SkinLayoutEntity.const_318;
                  break;
               case "strech":
                  _loc5_.var_333 = SkinLayoutEntity.const_485;
                  break;
               case "tiled":
                  _loc5_.var_333 = SkinLayoutEntity.const_305;
                  break;
               case "center":
                  _loc5_.var_333 = SkinLayoutEntity.const_576;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_331 = SkinLayoutEntity.const_464;
                  break;
               case "move":
                  _loc5_.var_331 = SkinLayoutEntity.const_318;
                  break;
               case "strech":
                  _loc5_.var_331 = SkinLayoutEntity.const_485;
                  break;
               case "tiled":
                  _loc5_.var_331 = SkinLayoutEntity.const_305;
                  break;
               case "center":
                  _loc5_.var_331 = SkinLayoutEntity.const_576;
            }
         }
