package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1352:String = "skin";
      
      private static const const_1350:String = "bitmap";
      
      private static const const_1353:String = "fill";
      
      private static const const_1351:String = "text";
      
      private static const const_1348:String = "label";
      
      private static const const_1349:String = "shape";
      ...
      private var var_2260:Dictionary;
      
      private var var_2262:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2260 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1669,this.var_2260);
         this.var_2262 = new Dictionary();
         this.var_2261 = new Dictionary();
         StateCodeTable.fillTables(this.var_2262,this.var_2261);
         this.var_412 = new Dictionary();
         this.var_412[const_1352] = BitmapSkinRenderer;
         this.var_412[const_1350] = BitmapDataRenderer;
         this.var_412[const_1353] = FillSkinRenderer;
         this.var_412[const_1351] = TextSkinRenderer;
         this.var_412[const_1348] = LabelRenderer;
         this.var_412[const_1349] = ShapeSkinRenderer;
         this.var_412[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_412[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_338 == null)
         {
            var_338 = new Array();
            var_338.push(WindowState.const_74);
            var_338.push(WindowState.const_88);
            var_338.push(WindowState.const_95);
            var_338.push(WindowState.const_55);
            var_338.push(WindowState.const_87);
            var_338.push(WindowState.const_84);
            var_338.push(WindowState.const_89);
            var_338.push(WindowState.const_102);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1669[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_885[param1] = new Array(const_993);
         }
         this.var_885[param1][param2] = param3;
         if(this.var_884[param1] == null)
         {
            this.var_884[param1] = new Array(const_993);
         }
      ...
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc4_ && param2 != WindowStyle.const_180)
            {
               _loc4_ = _loc3_["null"];
            }
         }
