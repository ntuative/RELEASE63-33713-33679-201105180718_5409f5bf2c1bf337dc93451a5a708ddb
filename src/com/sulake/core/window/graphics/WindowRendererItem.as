package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1044) : uint(const_656);
         ...
         if(_loc5_ != const_656)
         {
            this.var_1494 = this.var_966;
            _loc4_ = param1.fetchDrawBuffer() as BitmapData;
            if(_loc4_ != null)
            {
               _loc4_.lock();
               if(_loc5_ == const_1043)
               {
                  _loc6_ = true;
                  ...
                  if(this.var_640)
                  {
                     ...
                     _loc7_.draw(param1,this.var_116,this.var_116.rect,this.var_966,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_34))
                  {
                     this.var_1091.tx = param2.x;
                     this.var_1091.ty = param2.y;
                     this.var_839.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_116,this.var_1091,this.var_839,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      private function resolveSkinRenderer(param1:IWindow) : ISkinRenderer
      {
         ...
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_180)
            {
               _loc2_ = this._skinContainer.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_180);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1494;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_1145:
               if(param1.testParamFlag(WindowParam.const_34))
               {
                  _loc4_ = true;
               }
            ...
            case WindowRedrawFlag.const_1177:
               ...
               break;
            case WindowRedrawFlag.const_1287:
               _loc4_ = true;
         }
         if(_loc4_)
         {
