package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_476[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_839.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_839.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_839.blueMultiplier = (param1.color & 255) / 255;
               this.var_839.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_839);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_333 == SkinLayoutEntity.const_318)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_333 == SkinLayoutEntity.const_485)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_333 == SkinLayoutEntity.const_305)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_333 == SkinLayoutEntity.const_576)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_331 == SkinLayoutEntity.const_318)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_331 == SkinLayoutEntity.const_485)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_331 == SkinLayoutEntity.const_305)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_331 == SkinLayoutEntity.const_576)
                  {
                  ...
                  else if(_loc10_.var_331 == SkinLayoutEntity.const_305 || _loc10_.var_333 == SkinLayoutEntity.const_305)
                  {
                  ...
                  {
                     this.var_280.a = REGION.width;
                     this.var_280.d = REGION.height;
                     this.var_280.tx = REGION.x;
                     this.var_280.ty = REGION.y;
                     ALPHA.alphaMultiplier = (_loc19_.getPixel32(0,0) >>> 24) / 255;
                     _loc6_.draw(_loc18_,this.var_280,ALPHA);
                  }
                  else
                  {
                     this.var_280.a = 0 / _loc18_.width;
                     this.var_280.d = 0 / _loc18_.height;
                     this.var_280.tx = 0;
                     this.var_280.ty = 0;
                     _loc31_ = new BitmapData(REGION.width,REGION.height,_loc18_.transparent);
                     _loc31_.draw(_loc18_,this.var_280);
                     _loc32_ = new BitmapData(REGION.width,REGION.height,true,0);
                     _loc32_.draw(_loc19_,this.var_280,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_333 == SkinLayoutEntity.const_318)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_331 == SkinLayoutEntity.const_318)
               {
