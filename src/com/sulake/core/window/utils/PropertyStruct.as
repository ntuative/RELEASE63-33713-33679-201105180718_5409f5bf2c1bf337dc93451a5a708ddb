package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public static const const_163:String = "hex";
      
      public static const const_41:String = "int";
      
      public static const const_255:String = "uint";
      ...
      public static const const_266:String = "Rectangle";
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2964 = param3 == const_245 || param3 == const_145 || param3 == const_233 || param3 == const_266;
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            ...
            case const_266:
               ...
               break;
            case const_163:
               _loc1_ = "<var key=\"" + this.var_685 + "\" value=\"" + "0x" + uint(this.var_194).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_685 + "\" value=\"" + this.var_194 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
