package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_540:Array;
      ...
      private static const const_1486:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_88[const_196],var_88[ITALIC],var_88[BOLD]];
            var_88.reset();
            var_88[const_196] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_540.indexOf(_loc4_.name) == -1)
            {
               var_540.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_659);
         if(countSubStrings(param1,const_658) != countSubStrings(param1,const_659))
         {
            throw new Error("Mismatching amount of \"" + const_658 + "\" versus \"" + const_659 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1485) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1486) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_658)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
