package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1343:String = "_TITLE";
      
      private static const const_1346:String = "_HEADER";
      
      private static const const_1345:String = "_CONTENT";
      
      private static const const_1344:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1380:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1343) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1380 = findChildByTag(const_1346) as IHeaderWindow;
            if(!this.var_1380)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_183 = findChildByTag(const_1345) as IWindowContainer;
            if(!this.var_183)
            {
      ...
      {
         return findChildByTag(const_1344) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1334,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1086 ? this.content.iterator : new Iterator(this);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_256,_loc3_.left,PropertyStruct.const_41,_loc2_));
