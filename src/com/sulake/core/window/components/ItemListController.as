package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2139:Boolean = false;
      ...
      protected var var_700:Number = -1.0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this._container = _context.create("_CONTAINER","",WindowType.const_402,WindowStyle.const_180,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_191,this.containerEventHandler);
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_191,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_207:
               if(this.var_1341)
               {
                  this.var_1343 = this.var_2140 - _loc3_;
                  this.var_1344 = this.var_2141 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1343 != 0 && this.var_112 != 0)
                     {
                        this.scrollH += this.var_1343 / this.var_112;
                     }
                  }
                  else if(this.var_1344 != 0 && this.var_99 != 0)
                  {
                     this.scrollV += this.var_1344 / this.var_99;
                  }
                  this.var_2140 = _loc3_;
                  this.var_2141 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_201:
               if(this.var_1341)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1343,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1344);
                  }
                  this.var_1341 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1083 && !this.var_568 && this._container)
         {
            this.var_568 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_808)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_424,this._spacing,PropertyStruct.const_41,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1109);
         }
         if(this.var_1083 != PropertyDefaults.const_1193)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_839,this.var_1083,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1622);
         }
         if(this.var_478 != PropertyDefaults.const_1135)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_781,this.var_478,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1640);
         }
         if(this.var_1342 != PropertyDefaults.const_1209)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_881,this.var_1342,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1612);
         }
         if(this.var_699 != PropertyDefaults.const_1203)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_866,this.var_699,PropertyStruct.const_119,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1762);
         }
         if(this.var_700 != PropertyDefaults.const_1138)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_774,this.var_700,PropertyStruct.const_119,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1680);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_774:
                  this.var_700 = _loc2_.value as Number;
                  break;
            }
         }
