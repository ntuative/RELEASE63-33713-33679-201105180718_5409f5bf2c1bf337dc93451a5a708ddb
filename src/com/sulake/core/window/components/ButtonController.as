package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_442:String = "_BTN_TEXT";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = getChildByName(const_442);
         if(_loc2_ != null)
         {
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               ...
               case WindowEvent.const_264:
                  try
                  {
                     getChildByName(const_442).blend = getChildByName(const_442).blend + 0.5;
                  }
                  catch(e:Error)
                  {
                  }
