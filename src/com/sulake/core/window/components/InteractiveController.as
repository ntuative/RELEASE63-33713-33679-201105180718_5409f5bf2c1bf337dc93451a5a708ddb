package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_589)
         {
            if(param2.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
            {
               param1.context.getWindowServices().getToolTipAgentService().begin(param1);
            }
            else if(param2.type != WindowMouseEvent.const_207)
            {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_589)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_935,param1.toolTipCaption,PropertyStruct.const_53,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1756);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1142)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_717,param1.toolTipDelay,PropertyStruct.const_255,true));
         }
         else
         {
      ...
      {
         this.var_1356 = param1 == null ? "null" : param1;
      }
