package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_925:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1764:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1160 == param2)
         {
            return;
         }
         param1.var_1160 = param2;
         param1.var_1764 = null;
         if(param1.var_1160 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1160);
            param1.var_1764 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_870.indexOf(param1) > -1)
         {
            this.var_751 = param1;
         }
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1764;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1165)
            {
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_765,this.var_751,PropertyStruct.const_53,true,PropertyDefaults.const_870));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1701);
         }
         return _loc1_;
      }
