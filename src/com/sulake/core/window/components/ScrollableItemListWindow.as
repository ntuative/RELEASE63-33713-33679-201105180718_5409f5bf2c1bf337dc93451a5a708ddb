package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1321:IItemListWindow;
      
      private var var_469:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_469)
         {
            this.var_469.removeEventListener(WindowEvent.const_264,this.scrollBarEventProc);
            this.var_469.removeEventListener(WindowEvent.const_291,this.scrollBarEventProc);
            this.var_469 = null;
         }
         if(this.var_1321)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1321)
         {
            this.var_1321 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_469)
         {
            this.var_469 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_469)
            {
               this.var_469.addEventListener(WindowEvent.const_264,this.scrollBarEventProc);
               this.var_469.addEventListener(WindowEvent.const_291,this.scrollBarEventProc);
            }
         }
         return this.var_469;
      }
