package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      {
         this.var_1356 = param1 == null ? "" : param1;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_786 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_385,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_331,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_793,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1620);
         _loc1_.push(this.var_1355 != PropertyDefaults.const_1118 ? new PropertyStruct(PropertyDefaults.const_797,this.var_1355,PropertyStruct.const_38,true) : PropertyDefaults.const_1902);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1098 ? new PropertyStruct(PropertyDefaults.const_853,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1665);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1219 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1862);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_797:
                  this.var_1355 = _loc2_.value as Boolean;
                  if(this.var_1355)
                  {
               ...
               case PropertyDefaults.const_793:
                  ...
                  break;
               case PropertyDefaults.const_1276:
