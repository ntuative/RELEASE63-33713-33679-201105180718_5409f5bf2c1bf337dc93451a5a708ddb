package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1355:String = "_SELECTOR";
      
      private static const const_1354:String = "_CONTENT";
       
      
      protected var var_1082:ITabSelectorWindow;
      
      protected var var_2137:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1082 = findChildByTag(const_1355) as ITabSelectorWindow;
            if(this.var_1082 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2137 = findChildByTag(const_1354) as IWindowContainer;
         }
      ...
      {
         return !!this.var_786 ? this.selector.iterator : null;
      }
      ...
      {
         return this.selector.method_2(param1);
      }
