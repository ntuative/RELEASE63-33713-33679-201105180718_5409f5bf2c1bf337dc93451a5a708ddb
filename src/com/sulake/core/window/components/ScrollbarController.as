package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1559:String = "increment";
      
      private static const const_1560:String = "decrement";
      
      private static const const_1074:String = "slider_track";
      
      private static const const_667:String = "slider_bar";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_176 = false;
         this.var_19 = param12;
         this._horizontal = param2 == WindowType.const_584;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_19 != null && !this.var_19.disposed)
         {
            ...
            this.var_19.removeEventListener(WindowEvent.const_546,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_40,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_546,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1030 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return this.track.findChildByName(const_667) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_667:
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_334)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_43 || param1.type == WindowTouchEvent.const_741)
         {
            ...
            else if(param2.name == const_1560)
            {
               if(this.var_19)
               {
                  this.var_1290 = true;
            ...
            else if(param2.name == const_1074)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_667).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_334)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1030) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1030) as IScrollableWindow;
               if(_loc1_)
               {
