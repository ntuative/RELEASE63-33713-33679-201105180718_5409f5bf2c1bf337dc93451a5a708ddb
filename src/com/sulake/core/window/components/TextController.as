package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1330:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_873:Number;
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_824 ? true : null;
         }
      ...
      {
         this.var_873 = param1;
         this._field.scrollH = this.var_873 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_873 * this.maxScrollH,this.var_572 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_960,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1201));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1112 ? new PropertyStruct(PropertyDefaults.const_758,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1185) : PropertyDefaults.const_1673);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_38,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_163,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_255,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1308 ? new PropertyStruct(PropertyDefaults.const_1204,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1150) : PropertyDefaults.const_1821);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_902) ? new PropertyStruct(PropertyDefaults.const_428,this._field.textColor,PropertyStruct.const_163,true) : PropertyDefaults.const_1275);
         ...
         _loc1_.push(this.var_42.left != PropertyDefaults.const_869 ? new PropertyStruct(PropertyDefaults.const_256,this.var_42.left,PropertyStruct.const_41,true) : PropertyDefaults.const_867);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_887 ? new PropertyStruct(PropertyDefaults.const_240,this.var_42.top,PropertyStruct.const_41,true) : PropertyDefaults.const_924);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_963 ? new PropertyStruct(PropertyDefaults.const_262,this.var_42.right,PropertyStruct.const_41,true) : PropertyDefaults.const_980);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_855 ? new PropertyStruct(PropertyDefaults.const_294,this.var_42.bottom,PropertyStruct.const_41,true) : PropertyDefaults.const_693);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1148 ? new PropertyStruct(PropertyDefaults.const_755,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1882);
