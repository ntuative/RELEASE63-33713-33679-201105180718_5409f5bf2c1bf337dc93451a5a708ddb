package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1647:int = 10000;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_206 = new Timer(const_1647,1);
         this.var_206.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_206.stop();
            this.var_206.removeEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
         }
         this.var_206 = null;
         this.var_529 = null;
         this.var_528 = null;
      ...
      public function addMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_251.addConnectionMessageEvent(this._id,param1);
      }
      ...
      public function removeMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_251.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc6_:ByteArray = this.var_791.encoder.encode(_loc4_,_loc5_,param2);
         if(this.var_528)
         {
         ...
         {
            _loc3_ = this.var_1216.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      public function processReceivedData() : void
      {
         ...
         try
         {
            for each(message in receivedMessages)
            {
               ...
               {
                  eventsForClass = this.var_251.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = this.var_251.getMessageParser(parserClass);
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_529.writeByte(this.var_78.readUnsignedByte());
         }
      }
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         _loc2_.text = "Socket Timeout (" + this.var_206.delay + " ms). Possible Firewall.";
