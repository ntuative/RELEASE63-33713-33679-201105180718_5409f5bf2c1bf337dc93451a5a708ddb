package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1914:uint = 1;
      
      protected static const const_1915:uint = 2;
      
      protected static const const_1913:uint = 4;
      
      protected static const const_1916:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1751:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1123:Boolean = false;
      ...
      protected var var_589:Class;
      
      protected var var_482:uint = 0;
      ...
      protected var var_2927:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1123)
         {
            ...
            while(var_787.length < const_1776 && false)
            {
               _loc1_ = var_960.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1086 ? uint(this.var_1350 - this.var_2153) : uint(getTimer() - this.var_2153);
      }
      ...
      {
         if(this.var_1087 && !_disposed)
         {
            this.var_1087 = false;
            if(!this.var_1086 && this.var_243)
            {
               this.var_1350 = -1;
               this.var_2153 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1086 && !_disposed && this.var_1351 > 0)
         {
            try
            {
               this.var_43.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_243,const_1751 - this.var_1351);
            if(this.var_2927)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_482 = LibraryLoader.name_4;
         ...
         if(this.var_482 == LibraryLoader.const_1916)
         {
         ...
         if(this.var_482 == LibraryLoader.name_4)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_589 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_589.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
