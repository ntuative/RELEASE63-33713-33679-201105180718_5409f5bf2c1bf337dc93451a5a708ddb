package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      private var var_1653:AssetTypeDeclaration;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_109 is BitmapDataAsset)
         {
            ...
            this.var_1516 = BitmapDataAsset(this.var_109).var_1516;
            this.var_1515 = BitmapDataAsset(this.var_109).var_1515;
            if(this._bitmap != null)
            {
               this.var_109 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1516 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1515 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
