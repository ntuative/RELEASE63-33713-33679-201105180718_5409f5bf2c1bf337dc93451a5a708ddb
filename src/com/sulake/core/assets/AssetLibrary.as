package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1155:String = "AssetLibraryReady";
      
      public static const const_930:String = "AssetLibraryLoaded";
      
      public static const const_1627:String = "AssetLibraryUnloaded";
      
      public static const const_1681:String = "AssetLibraryLoadError";
      
      private static const const_457:String = "name";
      
      private static const const_1002:String = "asset";
      
      private static const const_1000:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1001:String = "library";
      
      private static var var_300:Dictionary;
      
      private static var var_1711:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_501;
         this.var_419 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_590 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1001);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1002);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1000);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_590 + "!");
               }
               _loc15_++;
            }
         }
      ...
      {
         if(this.var_590 == param1.url && this.var_896)
         {
            if(!this.var_898 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_589);
            }
            this.var_898 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1155));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         this.var_896 = false;
         this.var_590 = null;
         dispatchEvent(new Event(AssetLibrary.const_1627));
      }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1117,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_417;
                     this.var_418.push(struct.assetName);
                  }
      ...
      {
         return param1 < this.var_418.length ? this.getAssetByName(this.var_418[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_157)
         {
            ...
            {
               return this.var_418.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_157[param1] != null || (this.var_589 != null ? this.var_589[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1711.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_419.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_419[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_419[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_419)
         {
            _loc3_ = AssetTypeDeclaration(this.var_419[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_419)
         {
            _loc4_ = AssetTypeDeclaration(this.var_419[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_589 = _loc2_.resource;
         this.var_590 = _loc2_.url;
         if(this.var_898)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_589);
         }
         this.var_896 = true;
         dispatchEvent(new Event(AssetLibrary.const_930));
         dispatchEvent(new Event(AssetLibrary.const_1155));
         if(this.var_898)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1681));
         this.var_43 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1001);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1002);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_457).toString() == param1)
               {
                  ...
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_590 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_589[param1]);
                  _loc6_ = _loc3_.child(const_1000);
                  if(_loc6_.length())
                  {
