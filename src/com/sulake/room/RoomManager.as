package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1688:int = 0;
      ...
      private var var_2987:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_848,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_647 == null || this.var_534 == null)
         {
            return;
         }
         this._state = const_1785;
         if(this.var_1229 != null)
         {
            _loc1_ = this.var_1229;
            this.var_1229 = null;
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_635.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_635[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc13_:int = 1;
         var _loc14_:IRoomObject = _loc6_.method_13(param2,_loc13_,param3,param4);
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_752)
         {
            return;
         }
         if(this.var_55 == null)
         {
            this._state = const_752;
            return;
         }
         if(this.var_55.getGraphicAssetCollection(param1) != null)
         {
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(this.var_970.indexOf(_loc2_) < 0)
         {
            this.var_970.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_970.length > 0)
         {
            _loc2_ = this.var_970[0];
            this.var_970.splice(0,1);
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_55 == null || this.var_534 == null)
         {
            return;
         }
                     ...
                     if(_loc15_ != null)
                     {
                        ...
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_647.createRoomObjectLogic(_loc6_);
