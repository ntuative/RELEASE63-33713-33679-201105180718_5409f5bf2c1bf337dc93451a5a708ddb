   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_263 != null)
         {
            ...
            {
               _loc3_ = this.var_263.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         return this.var_594[param1];
      }
      
      public function setNumber(param1:String, param2:Number, param3:Boolean = false) : void
      {
         if(this.var_1405.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         ...
         if(this.var_594[param1] != param2)
         {
            this.var_594[param1] = param2;
         }
      }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_635.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_635[_loc2_]);
      ...
      public function method_13(param1:int, param2:int, param3:String, param4:int) : IRoomObject
      {
         var _loc6_:* = null;
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(this.var_263.getValue(_loc2_) != null)
         {
            return this.var_263.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
      ...
      {
         return this.var_263.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_263.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_263.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
