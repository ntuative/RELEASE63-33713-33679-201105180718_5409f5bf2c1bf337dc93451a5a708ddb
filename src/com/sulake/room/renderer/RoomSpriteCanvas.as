package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_665:Point = new Point(0,0);
      ...
      private static const const_1400:Number = 50;
      ...
      private var var_258:Sprite;
      
      private var var_138:Sprite;
      
      private var var_101:Sprite;
      ...
      private var var_1454:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2463:Number = -1.0E7;
      
      private var var_2461:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_258 = new Sprite();
         this.var_258.mouseEnabled = false;
         this.var_101 = new Sprite();
         this.var_101.name = "canvas";
         this.var_101.mouseEnabled = false;
         this.var_258.addChild(this.var_101);
         this.var_101.mouseEnabled = true;
         this.var_101.doubleClickEnabled = true;
         this.var_101.addEventListener(MouseEvent.CLICK,this.clickHandler);
         this.var_101.addEventListener(MouseEvent.DOUBLE_CLICK,this.clickHandler);
         this._geometry = new RoomGeometry(param5,new Vector3d(-135,30,0),new Vector3d(11,11,5),new Vector3d(-135,0.5,0));
         this.var_257 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
         ...
         this.var_839 = new ColorTransform();
      ...
      {
         this.var_511.x -= param1 - this.var_615;
         this.var_615 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_511.y -= param1 - this.var_618;
         this.var_618 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1015 = true;
            if(this.var_138 != null && !this.var_258.contains(this.var_138))
            {
               this.var_258.addChild(this.var_138);
               this.var_101.mask = this.var_138;
            }
         }
         else if(!param1 && this.var_1015)
         {
            this.var_1015 = false;
            if(this.var_138 != null && this.var_258.contains(this.var_138))
            {
               this.var_258.removeChild(this.var_138);
               this.var_101.mask = null;
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_258.numChildren > 0)
            {
               this.var_258.removeChildAt(0);
            }
            this.var_258 = null;
         }
         this.var_101 = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_513 != this.var_2465 || this.var_510 != this.var_2462)
         {
            _loc8_ = true;
         }
         if(this.var_101.x != this.var_615 || this.var_101.y != this.var_618)
         {
            this.var_101.x = this.var_615;
            this.var_101.y = this.var_618;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_512.sortOn("z",0 | 0);
         if(_loc5_ < this.var_512.length)
         {
            this.var_512.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_512[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2465 = this.var_513;
         this.var_2462 = this.var_510;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1453 > 0)
         {
            _loc2_ = param1 - this.var_1453;
            if(_loc2_ > const_1018 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2460 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_765;
               if(this.var_765 == const_365 + 1)
               {
                  this.var_559 = _loc2_;
                  this.var_1797 = this.var_2459;
               }
               else if(this.var_765 > const_365 + 1)
               {
                  _loc3_ = Number(this.var_765 - const_365);
                  this.var_559 = this.var_559 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1797 = this.var_1797 * (_loc3_ - 1) / _loc3_ + Number(this.var_2459) / _loc3_;
                  if(this.var_765 > const_365 + const_1399)
                  {
                     this.var_765 = const_365;
                     if(!this.var_1175 && this.var_559 > const_1018)
                     {
                        this.var_1175 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1175 && this.var_559 < const_1400)
                     {
                        this.var_1175 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1795 && this.var_1175);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_615;
                  ...
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_512.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_615;
      ...
      {
         if(param1 < this.var_513 && param1 + param3 >= 0 && (param2 < this.var_510 && param2 + param4 >= 0))
         {
            if(!this.var_2945)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param2 + param4 >= this.var_510)
         {
            param4 -= this.var_510 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2464)
         {
      ...
      private function getSprite(param1:int) : ExtendedSprite
      {
         ...
         return this.var_101.getChildAt(param1) as ExtendedSprite;
      }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            this.var_101.addChild(_loc3_);
            ++this.var_931;
         }
         else
         {
            this.var_101.addChildAt(_loc3_,param2);
         }
         ++this.var_764;
      }
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         if(_loc4_ != null)
         {
            if(_loc4_.varyingDepth != _loc3_.varyingDepth)
            {
               if(_loc4_.varyingDepth && !_loc3_.varyingDepth)
               {
                  this.var_101.removeChildAt(param1);
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_764 || this.var_764 == 0)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_512.length)
         {
            return null;
         }
         return this.var_512[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_257.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_257.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_665);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_839.redMultiplier = tR;
            this.var_839.greenMultiplier = tG;
            this.var_839.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_839);
            if(name.length > 0)
            {
               this.var_257.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1174 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1798;
         }
         this.var_1798 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1174;
         return this.var_1798;
      }
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc12_:Number = param2 - this.var_510 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1796,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2463 || param2 != this.var_2461)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         while(_loc1_ < this.var_360.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1454.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
