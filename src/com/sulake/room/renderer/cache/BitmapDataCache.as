package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function BitmapDataCache(param1:int, param2:int, param3:int = 1)
      {
         ...
         this.var_1993 = param2 * 1024 * 1024;
         this.var_1549 = param3 * 1024 * 1024;
         if(this.var_1549 < 0)
         {
            this.var_1549 = 0;
         }
      ...
      {
         this.var_1022 += this.var_1549;
         if(this.var_1022 > this.var_1993)
         {
            this.var_1022 = this.var_1993;
         }
      }
      ...
      public function addBitmapData(param1:String, param2:ExtendedBitmapData) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               this.var_830 -= _loc4_.width * _loc4_.height * 4;
            }
         ...
         this.var_830 += param2.width * param2.height * 4;
      }
   }
}
